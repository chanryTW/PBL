...
function paswLock(a){a=a.toString();var r="VTCJGAYKFP".split(""),q=Math.floor(9*Math.random())+0,n=9-q,l=Math.floor(9*Math.random())+0,p=9-l,e;if(10>a){var k=e=0;a=a.substr(0,1)}else 100>a?(e=0,k=a.substr(0,1),a=a.substr(1,1)):(e=a.substr(0,1),k=a.substr(1,1),a=a.substr(2,1));return""+r[q]+r[e]+r[k]+r[l]+r[p]+r[a]+r[n]}
angular.module("app.controllers",["ngImgCrop","angular-bind-html-compile"]).controller("loginCtrl",["$scope","$stateParams","$ionicPopup","$state","$ionicLoading",function(a,r,q,n,l){a.loginSmtBtn=function(){l.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u767b\u5165\u4e2d...</p>'});firebase.auth().signInWithEmailAndPassword(accountL.value+"@nkust.edu.tw",pwdL.value).then(function(){console.log("\u767b\u5165\u6210\u529f");var a=accountL.value.toUpperCase();accountL.value=
"";pwdL.value="";l.hide();"ROOT"==a?n.go("rootmenu.root_pbl",{StuID:a}):n.go("choose_class",{StuID:a})})["catch"](function(a){var e=a.code;console.log("\u767b\u5165\u5931\u6557\uff1a",a.message);l.hide();switch(e){case "auth/user-not-found":a=q.alert({title:"\u767b\u5165\u5931\u6557",template:"\u67e5\u7121\u6b64\u5e33\u865f\u3002"});a.then(function(a){accountL.value="";pwdL.value=""});break;case "auth/invalid-email":a=q.alert({title:"\u767b\u5165\u5931\u6557",template:"\u683c\u5f0f\u6709\u8aa4\u3002"});
a.then(function(a){accountL.value=""});break;case "auth/wrong-password":a=q.alert({title:"\u767b\u5165\u5931\u6557",template:"\u5bc6\u78bc\u932f\u8aa4\u3002"}),a.then(function(a){pwdL.value=""})}})};a.forgetBtn=function(){a.data={};q.show({title:"\u5fd8\u8a18\u5bc6\u78bc",subTitle:"\u8acb\u8f38\u5165\u5b78\u865f\uff0c\u91cd\u8a2d\u4fe1\u4ef6\u5c07\u5bc4\u9001\u81f3nkust\u4fe1\u7bb1",template:'<input type="text" ng-model="data.forgetInput" placeholder="ex:C107193000">',scope:a,buttons:[{text:"\u53d6\u6d88",
type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},{text:"\u9001\u51fa",type:"button-chanry1",onTap:function(l){console.log("\u9078\u64c7\u9001\u51fa");firebase.auth().sendPasswordResetEmail(a.data.forgetInput+"@nkust.edu.tw").then(function(){console.log("\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u6210\u529f");q.alert({title:"\u6210\u529f",template:"\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u6210\u529f\uff0c\u8acb\u81f3 "+a.data.forgetInput+"@nkust.edu.tw \u6536\u4fe1"})})["catch"](function(a){console.log("\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u5931\u6557");
switch(a.code){case "auth/user-not-found":q.alert({title:"\u5bc4\u4fe1\u5931\u6557",template:"\u67e5\u7121\u6b64\u5e33\u865f\u3002"})}})}}]})}}]).controller("choose_classCtrl",["$scope","$stateParams","$state","$ionicLoading","$timeout",function(a,r,q,n,l){if(null!=r.StuID){n.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u8f09\u5165\u8ab2\u7a0b\u4e2d...</p>'});var p=[],e=firebase.firestore();e.collection("\u8ab2\u7a0b").where("ClassStu","array-contains",r.StuID).get().then(function(e){e.forEach(function(e){p.push(e.data());
a.items=p;a.$apply()})});n.hide();a.choose_class=function(a,f){e.collection("\u7cfb\u7d71\u8a18\u9304").doc(a).collection("\u767b\u5165\u7d00\u9304").add({StuID:r.StuID,time:new Date}).then(function(a){console.log("\u7cfb\u7d71\u7d00\u9304 - \u767b\u5165\u7d00\u9304\u6210\u529f")})["catch"](function(a){console.error("\u7cfb\u7d71\u7d00\u9304 - \u767b\u5165\u7d00\u9304\u5931\u6557\uff1a",a)});localStorage.setItem("ClassID",a);localStorage.setItem("ClassName",f);q.go("menu.pbl")}}else console.log("\u932f\u8aa4\u65b9\u5f0f"),
q.go("login")}]).controller("chatroomCtrl",["$scope","$stateParams","$state","$ionicLoading","$ionicScrollDelegate",function(a,r,q,n,l){var p=firebase.firestore();firebase.auth().onAuthStateChanged(function(e){if(e){console.log("\u5df2\u767b\u5165\u72c0\u614b");var k=e.email.substring(0,e.email.indexOf("@")).toUpperCase(),f=localStorage.getItem("ClassID"),g=localStorage.getItem("StuName");a.messages=[];p.collection("\u7559\u8a00\u7248").doc(f).collection("messages").orderBy("time","asc").onSnapshot(function(b){b.docChanges().forEach(function(b){"added"===
b.type&&p.collection("\u5e33\u865f").doc(b.doc.data().StuID).get().then(function(d){firebase.storage().ref().child("members/"+d.data().Img).getDownloadURL().then(function(c){a.messages.push({messageName:b.doc.data().StuID+" "+b.doc.data().StuName,messageImg:c,messageContent:b.doc.data().content,time:b.doc.data().time});a.$apply();l.scrollBottom();l.resize()})})["catch"](function(a){console.log("\u67e5\u8a62\u5716\u7247\u6a94\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)});"modified"===b.type&&console.log("\u4fee\u6539: ",
b.doc.data());"removed"===b.type&&console.log("\u522a\u9664: ",b.doc.data())})});a.addMessage=function(){n.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u65b0\u589e\u4e2d...</p>'});void 0!=a.inputMessage&&""!=a.inputMessage&&(p.collection("\u7559\u8a00\u7248").doc(f).collection("messages").add({StuID:k,StuName:g,content:a.inputMessage,time:new Date}).then(function(a){console.log("\u65b0\u589e\u7559\u8a00\u6210\u529f")})["catch"](function(a){console.error("\u65b0\u589e\u7559\u8a00\u5931\u6557\uff1a",
a)}),a.inputMessage="");n.hide()}}else console.log("\u5c1a\u672a\u767b\u5165"),q.go("login")})}]).controller("chatroom2Ctrl",["$scope","$stateParams","$state","$ionicLoading","$ionicScrollDelegate",function(a,r,q,n,l){var p=firebase.firestore();firebase.auth().onAuthStateChanged(function(e){if(e){console.log("\u5df2\u767b\u5165\u72c0\u614b");var k=e.email.substring(0,e.email.indexOf("@")).toUpperCase(),f=localStorage.getItem("ClassID"),g=localStorage.getItem("StuName");a.messages=[];p.collection("\u533f\u540d\u7559\u8a00\u7248").doc(f).collection("messages").orderBy("time",
"asc").onSnapshot(function(b){b.docChanges().forEach(function(b){"added"===b.type&&p.collection("\u5e33\u865f").doc(b.doc.data().StuID).get().then(function(d){firebase.storage().ref().child("members/"+d.data().Img).getDownloadURL().then(function(c){var m="\u533f\u540d",d="https://firebasestorage.googleapis.com/v0/b/co-writing-test.appspot.com/o/members%2Fdefault?alt=media&token=e511b185-cd79-47e2-b501-e026fd8da387";"ROOT"==b.doc.data().StuID&&(m=b.doc.data().StuID+" "+b.doc.data().StuName,d=c);a.messages.push({messageName:m,
...
""!=a.inputMessage&&(p.collection("\u533f\u540d\u7559\u8a00\u7248").doc(f).collection("messages").add({StuID:k,StuName:g,content:a.inputMessage,time:new Date}).then(function(a){console.log("\u65b0\u589e\u7559\u8a00\u6210\u529f")})["catch"](function(a){console.error("\u65b0\u589e\u7559\u8a00\u5931\u6557\uff1a",a)}),a.inputMessage="");n.hide()}}else console.log("\u5c1a\u672a\u767b\u5165"),q.go("login")})}]).controller("pblCtrl",["$scope","$stateParams","$state","$ionicPopup","$ionicLoading","$sce",
function(a,r,q,n,l,p){var e=firebase.firestore();firebase.auth().onAuthStateChanged(function(k){if(k){console.log("\u5df2\u767b\u5165\u72c0\u614b");var f=k.email.substring(0,k.email.indexOf("@")).toUpperCase(),g=localStorage.getItem("ClassID");e.collection("\u8ab2\u7a0b").doc(g).onSnapshot(function(b){a.items=[{ClassName:b.data().ClassName,ClassContent:p.trustAsHtml(b.data().ClassContent),lock:b.data().lock}];a.$apply();1==b.data().lock&&(console.log("\u8ab2\u7a0b\u9396\u5b9a"),q.go("login"))},function(a){console.error("\u8b80\u53d6\u8ab2\u7a0b\u767c\u751f\u932f\u8aa4\uff1a",
a);q.go("login")});e.collection("\u9ede\u6578").doc(g).onSnapshot(function(b){a.PointTops=[];for(var h={$jscomp$loop$prop$index$6:0};h.$jscomp$loop$prop$index$6<b.data().top.length;h={$jscomp$loop$prop$index$6:h.$jscomp$loop$prop$index$6},h.$jscomp$loop$prop$index$6++)e.collection("\u5e33\u865f").doc(b.data().top[h.$jscomp$loop$prop$index$6].StuID).get().then(function(c){return function(m){firebase.storage().ref().child("members/"+m.data().Img).getDownloadURL().then(function(h){a.PointTops.push({Name:m.data().Name,
Img:h,Point:b.data().top[c.$jscomp$loop$prop$index$6].Point});a.$apply()})}}(h))["catch"](function(a){console.log("\u67e5\u8a62\u5e33\u865f\u8cc7\u6599\u767c\u751f\u932f\u8aa4\uff1a",a)})},function(a){console.error("\u8b80\u53d6\u9ede\u6578\u6392\u884c\u699c\u767c\u751f\u932f\u8aa4\uff1a",a)});e.collection("\u8ab2\u7a0b").doc(g).onSnapshot(function(b){a.LockGroupShow=b.data().inviteLock;q.go(q.current,{},{reload:!0});console.log("\u662f\u5426\u958b\u653e\u5206\u7d44\uff1a",a.LockGroupShow)},function(a){console.error("\u641c\u5c0b\u662f\u5426\u958b\u653e\u5206\u7d44\u767c\u751f\u932f\u8aa4\uff1a",
a)});var b="";e.collection("\u5206\u7d44").doc(g).collection("student").doc(f).onSnapshot(function(d){!1===d.data().grouped?(console.log("\u6c92\u6709\u5c0f\u7d44",d.data()),a.leaderGroupShow=!1,a.addGroupShow=!0,a.quitGroupShow=!1,a.members=[],localStorage.setItem("GroupID","none"),q.go(q.current,{},{reload:!0})):!0===d.data().grouped&&(console.log("\u6709\u5c0f\u7d44",d.data()),a.addGroupShow=!1,e.collection("\u5206\u7d44").doc(g).collection("group").where("leader","==",f).get().then(function(h){h.empty?
...
e.collection("\u5e33\u865f").doc(c.id).get().then(function(b){a.Stus.push({StuID:c.id,Name:b.data().Name,Checked:!1});q.go(q.current,{},{reload:!0});c.id==m&&l.hide()})["catch"](function(a){console.log("\u67e5\u8a62\u59d3\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)})}});console.log("\u53d6\u5f97\u672a\u5206\u7d44\u540d\u55ae\uff1a",a.Stus);q.go(q.current,{},{reload:!0})})["catch"](function(a){console.log("\u53d6\u5f97\u672a\u5206\u7d44\u540d\u55ae\u767c\u751f\u932f\u8aa4\uff1a",a)});a.checkStus=[];e.collection("\u8ab2\u7a0b").doc(g).get().then(function(b){var c=
...
a.members=[];q.go(q.current,{},{reload:!0})})["catch"](function(a){console.error("\u89e3\u6563\u5c0f\u7d44\u5931\u6557\uff1a",a)})})})["catch"](function(a){console.log("\u89e3\u6563\u5c0f\u7d44\u932f\u8aa4\uff1a",a)})}}]}):"quit"==b&&n.confirm({title:"\u9000\u51fa\u5c0f\u7d44",template:"\u78ba\u5b9a\u8981\u9000\u51fa\u5c0f\u7d44\u55ce?",buttons:[{text:"\u53d6\u6d88",type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},{text:"\u9000\u51fa",type:"button-chanry1",onTap:function(a){console.log("\u9078\u64c7\u89e3\u6563");
...
a)})}}]})}}else console.log("\u5c1a\u672a\u767b\u5165"),q.go("login")})}]).controller("voteCtrl",["$scope","$stateParams","$ionicPopup","$state",function(a,r,q,n){var l=firebase.firestore();firebase.auth().onAuthStateChanged(function(p){if(p){console.log("\u5df2\u767b\u5165\u72c0\u614b");var e=p.email.substring(0,p.email.indexOf("@")).toUpperCase(),k=localStorage.getItem("ClassID"),f=localStorage.getItem("GroupID"),g=localStorage.getItem("StuName");a.votes=[];l.collection("\u6295\u7968").doc(k).collection(f).onSnapshot(function(b){b.empty?
...
Point:b.doc.data().Point,finished:b.doc.data().finished,HTML:q.trustAsHtml(b.doc.data().HTML),time:b.doc.data().time,lock:c,hide:!b.doc.data().hide,show:!1,isIRS:b.doc.data().isIRS,showMsg:"\u67e5\u770b\u66f4\u591a"});a.$apply();console.log("\u65b0\u589e: ",a.missions)}else"modified"===b.type?(console.log("\u4fee\u6539: ",b.doc.data()),m=a.missions.findIndex(function(a){return a.time.seconds===b.doc.data().time.seconds&a.time.nanoseconds===b.doc.data().time.nanoseconds}),-1!=m?(c=0,1==b.doc.data().lock?
...
d).put(h.files[0]).then(function(a){var b=a.bytesTransferred/a.totalBytes*100;p.show({template:"\u5df2\u4e0a\u50b3 "+b+"%"});switch(a.state){case firebase.storage.TaskState.PAUSED:console.log("\u4e0a\u50b3\u66ab\u505c");break;case firebase.storage.TaskState.RUNNING:console.log("\u4e0a\u50b3\u4e2d")}100==b&&(console.log("\u4e0a\u50b3\u6210\u529f"),p.hide())},function(a){console.log("\u4e0a\u50b3\u5931\u6557");p.hide();console.log(a);l.alert({title:"\u4e0a\u50b3\u5931\u6557",template:a})});h=a.response.findIndex(function(a){return"ARuBqgDSkFJDMHH2UCFg"===
...
a)})})})["catch"](function(a){console.log("\u9632\u4f5c\u5f0a - \u6aa2\u67e5\u662f\u5426\u5df2\u52a0\u5206\u767c\u751f\u932f\u8aa4\uff1a",a)})),a.SmallTask.SmallTask8_schedule=c.data().schedule);a.$apply()}):console.log("\u5c1a\u7121\u5c0f\u4efb\u52d9")},function(a){console.error("\u53d6\u5f97\u6e2c\u9a57\u8cc7\u6599\u767c\u751f\u932f\u8aa4\uff1a",a)});a.GoIRS=function(a,b,d){n.go("menu.irs",{TestID:a,TestName:b,TestContent:d})};a.chooseProposal=[];a.chooseProposalBtn=function(){a.proposals=[];p.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u8f09\u5165\u63d0\u6848\u805a\u7126\u4e2d...</p>'});
k.collection("\u63d0\u6848\u805a\u7126").doc(b).collection(d).get().then(function(b){if(b.empty)console.log("\u7121\u63d0\u6848\u805a\u7126"),p.hide();else{var c=b.docs.length,d=0;b.forEach(function(b){a.proposals.push({ID:b.id,ProposalName:b.data().ProposalName,brainstorming:b.data().brainstorming});d++;d==c&&p.hide()});console.log("\u53d6\u5f97\u63d0\u6848\u805a\u7126\uff1a",a.proposals)}})["catch"](function(a){console.log("\u53d6\u5f97\u672a\u5206\u7d44\u540d\u55ae\u767c\u751f\u932f\u8aa4\uff1a",
...
a)})})["catch"](function(a){console.error("\u56de\u50b3\u586b\u7b54\u7d50\u679c\u5931\u6557\uff1a",a)})}}]})}}else console.log("\u5c1a\u672a\u767b\u5165"),n.go("login")})}]).controller("pointCtrl",["$scope","$stateParams","$sce","$state",function(a,r,q,n){var l=firebase.firestore();firebase.auth().onAuthStateChanged(function(p){if(p){console.log("\u5df2\u767b\u5165\u72c0\u614b");var e=p.email.substring(0,p.email.indexOf("@")).toUpperCase(),k=localStorage.getItem("ClassID");a.points=[];l.collection("\u9ede\u6578").doc(k).collection(e).doc("\u9ede\u6578\u6b77\u7a0b\u8a18\u9304").collection("\u9ede\u6578\u6b77\u7a0b\u8a18\u9304").onSnapshot(function(f){f.docChanges().forEach(function(g){if("added"===
...
console.log("\u522a\u9664\u9ede\u6578\u6b77\u7a0b\u8a18\u9304\u4e0d\u6210\u529f"),a.$apply())})})}else console.log("\u5c1a\u672a\u767b\u5165"),n.go("login")})}]).controller("irsCtrl",["$scope","$stateParams","$sce","$state","$ionicScrollDelegate",function(a,r,q,n,l){var p=firebase.firestore();firebase.auth().onAuthStateChanged(function(e){if(e&&null!=r.TestID){var k=function(c){clearInterval(d);if(c){for(c=1;c<=a.rightAnswer.length;c++)console.log(a.rightAnswer[c-1],a.answer[c]),a.rightAnswer[c-1]==
a.answer[c]&&(h+=1),c>=a.rightAnswer.length&&(a.test.Grade=h==a.rightAnswer.length?100:h*Math.round(100/a.rightAnswer.length));a.response=[{Grade:a.test.Grade,answer:a.answer}];p.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(g).collection("\u4efb\u52d9\u5217\u8868").doc(b).get().then(function(c){var d=c.data().Name,h=c.data().Point;c=c.data().finished;c.push(f);p.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(g).collection("\u4efb\u52d9\u5217\u8868").doc(b).update({finished:c}).then(function(){console.log("\u66f4\u65b0\u5df2\u5b8c\u6210\u540d\u55ae\u6210\u529f");
p.collection("\u9ede\u6578").doc(g).collection(f).doc("\u9ede\u6578\u6b77\u7a0b\u8a18\u9304").collection("\u9ede\u6578\u6b77\u7a0b\u8a18\u9304").where("check","==",b).get().then(function(a){a.empty?(console.log("\u7b2c\u4e00\u6b21\u62ff\u734e\u52f5"),p.collection("\u9ede\u6578").doc(g).collection(f).doc("\u9ede\u6578\u6b77\u7a0b\u8a18\u9304").collection("\u9ede\u6578\u6b77\u7a0b\u8a18\u9304").add({content:"\u5b8c\u6210\u4efb\u52d9\uff1a"+d,point:paswLock(h),check:b,time:new Date}).then(function(a){console.log("\u52a0\u5206 - \u4e0a\u50b3\u4f3a\u670d\u5668\u6210\u529f")})["catch"](function(a){console.error("\u52a0\u5206 - \u4e0a\u50b3\u4f3a\u670d\u5668\u5931\u6557\uff1a",
a)})):(console.log("\u5df2\u62ff\u904e\u6b64\u734e\u52f5"),p.collection("\u7cfb\u7d71\u8a18\u9304").doc(g).collection("\u8cc7\u5b89\u56de\u5831").add({StuID:f,Content:"\u5df2\u62ff\u904e"+b+"\u734e\u52f5",time:new Date}).then(function(a){console.log("\u901a\u5831\u4f3a\u670d\u5668\u6210\u529f")})["catch"](function(a){console.error("\u901a\u5831\u4f3a\u670d\u5668\u5931\u6557\uff1a",a)}))})["catch"](function(a){console.log("\u9632\u4f5c\u5f0a - \u6aa2\u67e5\u662f\u5426\u5df2\u52a0\u5206\u767c\u751f\u932f\u8aa4\uff1a",
a)});a.$apply()})["catch"](function(a){console.error("\u66f4\u65b0\u5df2\u5b8c\u6210\u540d\u55ae\u5931\u6557",a)})})["catch"](function(a){console.log("\u53d6\u5f97\u5df2\u5b8c\u6210\u540d\u55ae\u767c\u751f\u932f\u8aa4\uff1a",a)})}else a.response=a.answer?[{answer:a.answer}]:[];p.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(g).collection("\u4efb\u52d9\u5217\u8868").doc(b).collection("\u586b\u7b54\u7d50\u679c").doc(f).set({StuID:f,missionID:b,response:a.response,time:new Date}).then(function(a){console.log("\u56de\u50b3\u586b\u7b54\u7d50\u679c\u6210\u529f")})["catch"](function(a){console.error("\u56de\u50b3\u586b\u7b54\u7d50\u679c\u5931\u6557\uff1a",
a)})};console.log("\u5df2\u767b\u5165\u72c0\u614b");var f=e.email.substring(0,e.email.indexOf("@")).toUpperCase(),g=localStorage.getItem("ClassID"),b=r.TestID;p.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(g).collection("\u4efb\u52d9\u5217\u8868").doc(b).get().then(function(a){-1!=a.data().finished.indexOf(f)&&(console.log("\u5df2\u5b8c\u6210\u904e\u6e2c\u9a57"),n.go("login"))})["catch"](function(a){console.log("\u6aa2\u67e5\u662f\u5426\u5df2\u5b8c\u6210\u767c\u751f\u932f\u8aa4\uff1a",a)});a.test={};
a.test.Name=r.TestName;a.test.Content=r.TestContent;a.rightAnswer=[];var d,h=0;a.search="fkozq65K\u984c\u76ee\uff1a01";a.pageUpShow=!1;a.pageDownShow=!0;a.FinishBtnShow=!1;a.testStart=!1;a.testContent=!0;a.testOver=!0;p.collection("IRS").doc(g).collection("\u6e2c\u9a57\u5217\u8868").doc(b).onSnapshot(function(b){function c(a){return 9>=a?"0"+String(a):a}var h=b.data().stageTime;a.distance=c(Math.floor(h/36E5))+":"+c(Math.floor(h%36E5/6E4))+":"+c(Math.floor(h%6E4/1E3));if(b.data().testStart){a.questions=
...
n.go("login")})}]).controller("brainstormingCtrl",["$scope","$stateParams","$state","$ionicScrollDelegate","$ionicLoading","$ionicPopup",function(a,r,q,n,l,p){var e=firebase.firestore();firebase.auth().onAuthStateChanged(function(k){if(k){console.log("\u5df2\u767b\u5165\u72c0\u614b");var f=k.email.substring(0,k.email.indexOf("@")).toUpperCase(),g=localStorage.getItem("StuName"),b=localStorage.getItem("ClassID"),d=localStorage.getItem("GroupID");a.search="fkozq65K\u9801\u7c64\uff1a1";a.tabs=function(h){if("+"==
h)10<=a.tabsCounts.length?p.confirm({title:"\u65b0\u589e\u5206\u9801",template:"\u5206\u9801\u5df2\u5230\u4e0a\u9650(10\u9801)\u3002",buttons:[{text:"\u597d\u7684",type:"button-chanry1",onTap:function(a){}}]}):p.confirm({title:"\u65b0\u589e\u5206\u9801",template:"\u78ba\u5b9a\u8981\u65b0\u589e\u55ce?",subTitle:"\u6ce8\u610f\uff1a\u65b0\u589e\u5f8c\u7121\u6cd5\u522a\u9664\uff0c\u4e0a\u9650\u70ba10\u500b\u5206\u9801\u3002",buttons:[{text:"\u53d6\u6d88",type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},
...
a.DelAllBtnShow=!0)})["catch"](function(a){console.log("\u5224\u65b7\u7d44\u9577\u767c\u751f\u932f\u8aa4\uff1a",a)});a.DelAllBtn=function(){p.confirm({title:"\u6e05\u7a7a\u8166\u529b\u6fc0\u76ea\u8cc7\u6599",template:"\u78ba\u5b9a\u8981\u6e05\u7a7a\u55ce?",subTitle:"\u6ce8\u610f\uff1a\u6e05\u7a7a\u6703\u522a\u9664\u5168\u9ad4\u7d44\u54e1\u8166\u529b\u6fc0\u76ea\u8cc7\u6599\u3002",buttons:[{text:"\u53d6\u6d88",type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},{text:"\u78ba\u5b9a",
...
c.type){var d=c.doc.data(),h=[];d.brainstorming.forEach(function(c){e.collection("\u8166\u529b\u6fc0\u76ea").doc(g).collection(b).doc(c).get().then(function(b){h.push(b.data());a.$apply()})["catch"](function(a){console.log("\u8166\u529b\u6fc0\u76ea\u5167\u5bb9\u767c\u751f\u932f\u8aa4\uff1a",a)})});var t=!1;-1!=c.doc.data().bellBadge.indexOf(f)&&(t=!0);a.items.push({ProposalName:d.ProposalName,brainstorming:h,bellBadge:t,time:d.time});p.scrollBottom();console.log("\u65b0\u589e: ",a.items)}else"modified"===
...
q.go("login")})}]).controller("settingCtrl",["$scope","$stateParams","$ionicLoading","$ionicPopup",function(a,r,q,n){var l=firebase.firestore();firebase.auth().onAuthStateChanged(function(p){if(p){console.log("\u5df2\u767b\u5165\u72c0\u614b");var e=p.email.substring(0,p.email.indexOf("@")).toUpperCase(),k=localStorage.getItem("ClassID");a.Passward=function(){n.show({title:"\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1",template:"\u78ba\u5b9a\u8981\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u55ce?",buttons:[{text:"\u53d6\u6d88",
type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},{text:"\u78ba\u5b9a",type:"button-chanry1",onTap:function(a){console.log("\u9078\u64c7\u78ba\u5b9a");q.show({template:"\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u4e2d..."});firebase.auth().sendPasswordResetEmail(e+"@nkust.edu.tw").then(function(){console.log("\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u6210\u529f");n.alert({title:"\u6210\u529f",template:"\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u6210\u529f\uff0c\u8acb\u81f3 "+
e+"@nkust.edu.tw \u6536\u4fe1"});q.hide()})["catch"](function(a){console.log("\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u5931\u6557\uff1a",a);q.hide()})}}]})};a.myImage="";a.myCroppedImage="";angular.element(document.querySelector("#uploadFileInput2")).on("change",function(e){e=e.currentTarget.files[0];var g=new FileReader;g.onload=function(b){a.$apply(function(a){a.myImage=b.target.result})};g.readAsDataURL(e)});a.ChangeImg=function(f){q.show({template:"\u4e0a\u50b3\u5716\u7247\u4e2d..."});if(""==
f)console.log("\u672a\u9078\u64c7\u6a94\u6848"),q.hide(),n.alert({title:"\u672a\u9078\u64c7\u6a94\u6848",template:"\u8acb\u5148\u9078\u64c7\u6a94\u6848\u518d\u4e0a\u50b3"});else{var g=firebase.storage().ref(),b=new Date,d=e+b.getFullYear().toString()+b.getMonth()+b.getDate()+b.getHours()+b.getMinutes()+b.getSeconds()+b.getMilliseconds();g.child("members/"+d).putString(f,"data_url").on("state_changed",function(a){q.show({template:"\u5df2\u4e0a\u50b3 "+a.bytesTransferred/a.totalBytes*100+"%"});switch(a.state){case firebase.storage.TaskState.PAUSED:console.log("\u4e0a\u50b3\u66ab\u505c");
break;case firebase.storage.TaskState.RUNNING:console.log("\u4e0a\u50b3\u4e2d")}},function(b){console.log("\u4e0a\u50b3\u5931\u6557");q.hide();console.log(b);n.alert({title:"\u4e0a\u50b3\u5716\u7247\u5931\u6557",template:b});a.myImage="";a.myCroppedImage=""},function(){console.log("\u4e0a\u50b3\u6210\u529f");q.hide();a.myImage="";a.myCroppedImage="";g.child("members/"+d).getDownloadURL().then(function(a){document.getElementById("menu-img").src=a});l.collection("\u5e33\u865f").doc(e).update({Img:d}).then(function(a){console.log("\u66f4\u65b0DB\u6a94\u540d\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0DB\u6a94\u540d\u5931\u6557\uff1a",
...
a})})}}else console.log("\u5c1a\u672a\u767b\u5165"),$state.go("login")})}]).controller("menuCtrl",["$scope","$stateParams","$ionicPopup","$state",function(a,r,q,n){var l=firebase.firestore();firebase.auth().onAuthStateChanged(function(p){if(p){console.log("\u5df2\u767b\u5165\u72c0\u614b");var e=p.email.substring(0,p.email.indexOf("@")).toUpperCase(),k=localStorage.getItem("ClassID");l.collection("\u5e33\u865f").doc(e).get().then(function(a){document.getElementById("menu-heading1").innerText=e+" "+
...
b.type){b=b.doc;console.log("\u6709\u4eba\u9080\u8acb");var d=b.data().groupID,h=b.id,c=b.data().leader;l.collection("\u5e33\u865f").doc(c).get().then(function(b){b=b.data().Name;var g=q.show({title:"\u5c0f\u7d44\u9080\u8acb",subTitle:c+" "+b+" \u9080\u8acb\u4f60\u52a0\u5165\u5c0f\u7d44\u3002",template:'<img class="inviteImg" src="img/invite.jpg">',scope:a,buttons:[{text:"\u62d2\u7d55",type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u62d2\u7d55");l.collection("\u5206\u7d44").doc(k).collection("student").doc(e).collection("invite").doc(h).update({respond:!0}).then(function(a){console.log("\u66f4\u65b0\u56de\u61c9\u72c0\u614b\u6210\u529f");
...
a)}))})})}else console.log("\u5c1a\u672a\u767b\u5165"),n.go("login")})}]).controller("root_pblCtrl",["$scope","$stateParams","$ionicPopup","$ionicLoading","$state",function(a,r,q,n,l){firebase.auth().onAuthStateChanged(function(p){if("eTlMITVmGbSStEQ7B7jw9rIl20N2"===p.uid){console.log("\u5df2\u767b\u5165\u72c0\u614b");var e=firebase.auth().currentUser,k=[];$("#excel-file").change(function(a){a=a.target.files;var b=new FileReader;b.onload=function(a){try{var b=XLSX.read(a.target.result,{type:"binary"})}catch(m){console.log("\u6a94\u6848\u578b\u5225\u4e0d\u6b63\u78ba");
return}for(var c in b.Sheets)b.Sheets.hasOwnProperty(c)&&(a=b.Sheets[c]["!ref"],console.log(a),k=k.concat(XLSX.utils.sheet_to_json(b.Sheets[c])));console.log(k)};b.readAsBinaryString(a[0])});var f=firebase.firestore();a.addClass=function(){var a=this.className;void 0===a||""===a||0===k.length?(console.log("\u672a\u586b"),q.alert({title:"\u932f\u8aa4",template:"\u8cc7\u6599\u672a\u586b\u5b8c\u6574\u3002"})):q.confirm({title:"\u5275\u7acb\u8ab2\u7a0b",template:"\u78ba\u5b9a\u5275\u7acb\u55ce?"}).then(function(b){if(b){console.log("\u78ba\u5b9a");
...
a)}),a.inputMessage2=""):1==c&&(console.log("2"+d),void 0!=d&&""!=d&&(f.collection("\u7559\u8a00\u7248").doc(b).collection("messages").add({StuID:"ROOT",StuName:"\u5289\u52c7\u5fd7 \u8001\u5e2b",content:d,time:new Date}).then(function(a){console.log("\u65b0\u589e\u7559\u8a00\u6210\u529f")})["catch"](function(a){console.error("\u65b0\u589e\u7559\u8a00\u5931\u6557\uff1a",a)}),a.inputMessage=""));n.hide()}}else q.alert({title:"\u932f\u8aa4",template:"\u8acb\u9078\u64c7\u8ab2\u7a0b\u3002"})}}else console.log("\u975e\u7ba1\u7406\u54e1"),
l.go("login")})}]).controller("root_groupCtrl",["$scope","$stateParams","$state","$ionicLoading",function(a,r,q,n){var l=firebase.firestore();firebase.auth().onAuthStateChanged(function(p){"eTlMITVmGbSStEQ7B7jw9rIl20N2"===p.uid?(console.log("\u5df2\u767b\u5165\u72c0\u614b"),a.cardShow=!1,l.collection("\u8ab2\u7a0b").get().then(function(e){a.AllClass=[];e.forEach(function(e){a.AllClass.push(e.data());q.go(q.current,{},{reload:!0})})}),a.choose_class=function(e,k){a.cardShow=!1;n.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u8f09\u5165\u8cc7\u6599\u4e2d...</p>'});
...
fontWeight:"bold"}}},labelLine:{normal:{show:!1}},data:[{value:g.length,name:"\u672a\u5206\u7d44"},{value:d.length,name:"\u5df2\u5206\u7d44"}]}]},"object"===typeof option)&&b.setOption(option,!0);a.cardShow=!0;n.hide();q.go(q.current,{},{reload:!0})})});a.Allgroups2=[];l.collection("\u5206\u7d44").doc(e).collection("group").get().then(function(b){b.forEach(function(b){for(var d=b.data(),c={$jscomp$loop$prop$index$22:0};c.$jscomp$loop$prop$index$22<b.data().members.length;c={$jscomp$loop$prop$index$22:c.$jscomp$loop$prop$index$22},
c.$jscomp$loop$prop$index$22++)l.collection("\u5e33\u865f").doc(b.data().members[c.$jscomp$loop$prop$index$22]).get().then(function(a){return function(b){d.members[a.$jscomp$loop$prop$index$22]+=b.data().Name}}(c))["catch"](function(a){console.log("\u67e5\u8a62\u59d3\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)});a.Allgroups2.push(d);q.go(q.current,{},{reload:!0})})})},a.LockGroupChange=function(a,k){l.collection("\u8ab2\u7a0b").doc(a).update({inviteLock:k}).then(function(a){console.log("\u66f4\u65b0inviteLock\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0inviteLock\u5931\u6557\uff1a",
a)})},a.maxMembersChange=function(a,k){l.collection("\u8ab2\u7a0b").doc(a).update({maxMembers:k}).then(function(a){console.log("\u66f4\u65b0maxMembers\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0maxMembers\u5931\u6557\uff1a",a)})}):(console.log("\u5c1a\u672a\u767b\u5165"),q.go("login"))})}]).controller("root_missionCtrl",["$scope","$stateParams","$state","$ionicPopup","$sce",function(a,r,q,n,l){var p=firebase.firestore();firebase.auth().onAuthStateChanged(function(e){"eTlMITVmGbSStEQ7B7jw9rIl20N2"===
e.uid?(console.log("\u5df2\u767b\u5165\u72c0\u614b"),a.cardShow=!1,p.collection("\u8ab2\u7a0b").get().then(function(e){a.AllClass=[];e.forEach(function(e){a.AllClass.push(e.data());q.go(q.current,{},{reload:!0})});console.log(a.AllClass)}),a.hide=function(){a.cardShow=!1},a.SelectBtn=function(e){if(void 0!=e){var f=e.ClassID;a.cardShow=!0;a.missions=[];p.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(f).collection("\u4efb\u52d9\u5217\u8868").onSnapshot(function(b){b.docChanges().forEach(function(b){if("added"===
...
optionA:"\u5289\u52c7\u5fd7",optionB:"\u9673\u4fe1\u69ae",optionC:"\u738b\u99a8\u8466",optionD:"\u9ec3\u570b\u74bd",answer:3}],p.collection("IRS").doc(d).collection("\u6e2c\u9a57\u5217\u8868").doc(b.id).set({Name:a.AddBtnPopup.Name,questions:a.AddBtnPopup.IRS.questions,stageTime:1E3*a.AddBtnPopup.IRS.stageTime,testStart:a.AddBtnPopup.IRS.testStart}).then(function(a){console.log("\u65b0\u589eIRS\u6210\u529f")})["catch"](function(a){console.error("\u65b0\u589eIRS\u5931\u6557\uff1a",a)}))})["catch"](function(a){console.error("\u65b0\u589e\u4efb\u52d9\u5931\u6557\uff1a",
a)}))}}]})};a.missionShow=function(b){var d=a.missions.findIndex(function(a){return a.$$hashKey===b.$$hashKey});-1!=d?(a.missions[d].show?(a.missions[d].show=!1,a.missions[d].showMsg="\u67e5\u770b\u66f4\u591a"):(a.missions[d].show=!0,a.missions[d].showMsg="\u6536\u5408\u5167\u5bb9"),console.log("\u4fee\u6539\u986f\u793a\u6210\u529f")):console.log("\u4fee\u6539\u986f\u793a\u4e0d\u6210\u529f")};a.response={};a.responseBtn=function(b){p.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(f).collection("\u4efb\u52d9\u5217\u8868").doc(b).collection("\u586b\u7b54\u7d50\u679c").add({StuID:"\u6559\u5e2b\u7248",
...
e?(a.missionStatus=[],p.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(f).collection("\u4efb\u52d9\u5217\u8868").doc(g).get().then(function(b){a.missionStatus=b.data();a.missionStatus.finished=b.data().finished;a.$apply();a.AllStu=[];p.collection("\u8ab2\u7a0b").doc(f).get().then(function(b){a.AllStu=b.data().ClassStu;a.unfinished=a.AllStu;for(b=0;b<a.missionStatus.finished.length;b++)if(-1!=a.unfinished.indexOf(a.missionStatus.finished[b])&&a.unfinished.splice(a.unfinished.indexOf(a.missionStatus.finished[b]),
1),b>=a.missionStatus.finished.length-1){console.log("\u6700\u5f8c\u4e00\u7b46");for(var d={$jscomp$loop$prop$j$24:0};d.$jscomp$loop$prop$j$24<a.missionStatus.finished.length;d={$jscomp$loop$prop$j$24:d.$jscomp$loop$prop$j$24},d.$jscomp$loop$prop$j$24++)p.collection("\u5e33\u865f").doc(a.missionStatus.finished[d.$jscomp$loop$prop$j$24]).get().then(function(b){return function(c){a.missionStatus.finished[b.$jscomp$loop$prop$j$24]+=c.data().Name;a.$apply()}}(d))["catch"](function(a){console.log("\u67e5\u8a62\u59d3\u540d\u767c\u751f\u932f\u8aa4\uff1a",
a)});for(d={$jscomp$loop$prop$j$4$26:0};d.$jscomp$loop$prop$j$4$26<a.unfinished.length;d={$jscomp$loop$prop$j$4$26:d.$jscomp$loop$prop$j$4$26},d.$jscomp$loop$prop$j$4$26++)p.collection("\u5e33\u865f").doc(a.unfinished[d.$jscomp$loop$prop$j$4$26]).get().then(function(b){return function(c){a.unfinished[b.$jscomp$loop$prop$j$4$26]+=c.data().Name;a.$apply()}}(d))["catch"](function(a){console.log("\u67e5\u8a62\u59d3\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)})}})},function(a){console.error("\u53d6\u5f97\u4efb\u52d9\u72c0\u614b\u767c\u751f\u932f\u8aa4\uff1a",
...
type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},{text:"\u522a\u9664",type:"button-chanry1",onTap:function(b){console.log("\u9078\u64c7\u522a\u9664");p.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(f).collection("\u4efb\u52d9\u5217\u8868").doc(g)["delete"]().then(function(b){console.log("\u522a\u9664\u4efb\u52d9\u8cc7\u6599\u6210\u529f");a.$apply()})["catch"](function(a){console.error("\u522a\u9664\u4efb\u52d9\u8cc7\u6599\u5931\u6557\uff1a",a)})}}]})}):(console.log("\u5c1a\u672a\u767b\u5165"),
q.go("login"))})}]).controller("root_brainstormingCtrl",["$scope","$stateParams","$state","$ionicPopup","$ionicLoading",function(a,r,q,n,l){var p=firebase.firestore();firebase.auth().onAuthStateChanged(function(e){"eTlMITVmGbSStEQ7B7jw9rIl20N2"===e.uid?(console.log("\u5df2\u767b\u5165\u72c0\u614b"),a.cardShow=!1,p.collection("\u8ab2\u7a0b").get().then(function(e){a.AllClass=[];e.forEach(function(e){a.AllClass.push(e.data());q.go(q.current,{},{reload:!0})});console.log(a.AllClass)}),a.hide=function(){a.cardShow=
!1},a.SelectBtn=function(e){if(void 0!=e){var f=e.ClassID;a.cardShow=!0;a.groups=[];p.collection("\u5206\u7d44").doc(f).collection("group").get().then(function(e){e.forEach(function(b){p.collection("\u5e33\u865f").doc(b.data().leader).get().then(function(d){a.groups.push({id:b.id,leader:b.data().leader+" "+d.data().Name});a.$apply()})["catch"](function(a){console.log("\u67e5\u8a62\u59d3\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)})})})["catch"](function(a){console.log("\u53d6\u5f97\u5404\u7d44\u5225\u767c\u751f\u932f\u8aa4\uff1a",
a)});a.DetailBtn=function(e){a.search="fkozq65K\u9801\u7c64\uff1a1";a.tabs=function(b){a.search="fkozq65K\u9801\u7c64\uff1a"+b;var d=a.tabsCounts.findIndex(function(a){return!0===a.active});a.tabsCounts[d].num=d+1;a.tabsCounts[d].active=!1;a.tabsCounts[b-1].num=b;a.tabsCounts[b-1].active=!0;$ionicScrollDelegate.scrollBottom()};p.collection("\u8166\u529b\u6fc0\u76ea").doc(f).collection(e).doc("\u9801\u7c64").get().then(function(b){if(b.exists){a.tabsCounts=[];for(var d=1;d<=b.data().count;d++)1==d?
a.tabsCounts.push({num:d,active:!0}):a.tabsCounts.push({num:d,active:!1});a.$apply()}else p.collection("\u8166\u529b\u6fc0\u76ea").doc(f).collection(e).doc("\u9801\u7c64").set({count:3}).then(function(){console.log("\u521d\u59cb\u5316\u5206\u9801\u6210\u529f")})["catch"](function(a){console.error("\u521d\u59cb\u5316\u5206\u9801\u5931\u6557",a)})})["catch"](function(a){console.log("\u53d6\u5f97 - \u9801\u7c64\u6578\u767c\u751f\u932f\u8aa4\uff1a",a)});a.items=[];p.collection("\u8166\u529b\u6fc0\u76ea").doc(f).collection(e).orderBy("time",
...
scope:a,buttons:[{text:"\u95dc\u9589",type:"button-chanry1",onTap:function(a){console.log("\u9078\u64c7\u95dc\u9589")}}]})}}else n.alert({title:"\u932f\u8aa4",template:"\u8acb\u9078\u64c7\u8ab2\u7a0b\u3002"})}):(console.log("\u5c1a\u672a\u767b\u5165"),q.go("login"))})}]).controller("root_proposalCtrl",["$scope","$stateParams","$state","$ionicPopup","$ionicLoading",function(a,r,q,n,l){var p=firebase.firestore();firebase.auth().onAuthStateChanged(function(e){"eTlMITVmGbSStEQ7B7jw9rIl20N2"===e.uid?(console.log("\u5df2\u767b\u5165\u72c0\u614b"),
a.cardShow=!1,p.collection("\u8ab2\u7a0b").get().then(function(e){a.AllClass=[];e.forEach(function(e){a.AllClass.push(e.data());q.go(q.current,{},{reload:!0})});console.log(a.AllClass)}),a.hide=function(){a.cardShow=!1},a.SelectBtn=function(e){if(void 0!=e){var f=e.ClassID;a.cardShow=!0;a.groups=[];p.collection("\u5206\u7d44").doc(f).collection("group").get().then(function(e){e.forEach(function(b){p.collection("\u5e33\u865f").doc(b.data().leader).get().then(function(d){a.groups.push({id:b.id,leader:b.data().leader+
" "+d.data().Name});a.$apply()})["catch"](function(a){console.log("\u67e5\u8a62\u59d3\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)})})})["catch"](function(a){console.log("\u53d6\u5f97\u5404\u7d44\u5225\u767c\u751f\u932f\u8aa4\uff1a",a)});a.DetailBtn=function(e){a.items=[];p.collection("\u63d0\u6848\u805a\u7126").doc(f).collection(e).orderBy("time","asc").get().then(function(b){b.forEach(function(b){var d=b.data(),c=[];d.brainstorming.forEach(function(b){p.collection("\u8166\u529b\u6fc0\u76ea").doc(f).collection(e).doc(b).get().then(function(b){c.push(b.data());
...
a.cardShow=!1,p.collection("\u8ab2\u7a0b").get().then(function(e){a.AllClass=[];e.forEach(function(e){a.AllClass.push(e.data());q.go(q.current,{},{reload:!0})});console.log(a.AllClass)}),a.hide=function(){a.cardShow=!1},a.SelectBtn=function(e){l.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u8f09\u5165\u8ab2\u7a0b\u9ede\u6578\u4e2d...</p>'});if(void 0!=e){var f=e.ClassID;a.cardShow=!0;a.StuPoints=[];p.collection("\u8ab2\u7a0b").doc(f).get().then(function(e){e.data().ClassStu.forEach(function(b){p.collection("\u9ede\u6578").doc(f).collection(b).doc("\u9ede\u6578\u6b77\u7a0b\u8a18\u9304").collection("\u9ede\u6578\u6b77\u7a0b\u8a18\u9304").get().then(function(d){var e=
0,c=d.docs.length,g=0,k=[];d.forEach(function(d){-1!=k.indexOf(d.data().check)?(console.log(b+"\u767c\u73fe\u91cd\u8907"),n.alert({title:b+"\u767c\u73fe\u91cd\u8907",template:"\u7de8\u865f\uff1a"+d.id}),p.collection("\u9ede\u6578").doc(f).collection(b).doc("\u9ede\u6578\u6b77\u7a0b\u8a18\u9304").collection("\u9ede\u6578\u6b77\u7a0b\u8a18\u9304").doc(d.id)["delete"]().then(function(a){console.log(d.id+"\u522a\u9664\u6210\u529f")})["catch"](function(a){console.error("\u522a\u9664\u5931\u6557\uff1a",
a)})):k.push(d.data().check);e+=pasw(d.data().point);g++;g==c&&(l.hide(),p.collection("\u5e33\u865f").doc(b).get().then(function(c){a.StuPoints.push({Name:b+" "+c.data().Name,StuID:b,Point:e});a.$apply()})["catch"](function(a){console.log("\u67e5\u8a62\u59d3\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)}))})})["catch"](function(a){console.log("\u8f09\u5165\u7e3d\u9ede\u6578\u767c\u751f\u932f\u8aa4\uff1a",a)})})})["catch"](function(a){console.log("\u53d6\u5f97\u8ab2\u7a0b\u540d\u55ae\u767c\u751f\u932f\u8aa4\uff1a",
a)});a.AddBtn=function(e){a.Stus=[];l.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u8f09\u5165\u5b78\u751f\u4e2d...</p>'});p.collection("\u5206\u7d44").doc(f).collection("student").get().then(function(b){b.forEach(function(d){var e=b.docs[b.docs.length-1].id,c=b.docs[b.docs.length-2].id;p.collection("\u5e33\u865f").doc(d.id).get().then(function(b){a.Stus.push({StuID:d.id,Name:b.data().Name,Checked:!1});d.id!=e&&d.id!=c||l.hide()})["catch"](function(a){console.log("\u67e5\u8a62\u59d3\u540d\u767c\u751f\u932f\u8aa4\uff1a",
...
a.data().Img).getDownloadURL().then(function(a){document.getElementById("menu-img").src=a})})["catch"](function(a){console.log("\u67e5\u8a62\u5716\u7247\u6a94\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)});document.getElementById("menu-heading2").innerText="Copyright \u00a9 2019 ver "+verson}else console.log("\u5c1a\u672a\u767b\u5165"),q.go("login")})}]);
