...
"ROOT"==a?l.go("rootmenu.root_pbl",{StuID:a}):l.go("choose_class",{StuID:a})})["catch"](function(a){var g=a.code;console.log("\u767b\u5165\u5931\u6557\uff1a",a.message);m.hide();switch(g){case "auth/user-not-found":a=k.alert({title:"\u767b\u5165\u5931\u6557",template:"\u67e5\u7121\u6b64\u5e33\u865f\u3002"});a.then(function(a){accountL.value="";pwdL.value=""});break;case "auth/invalid-email":a=k.alert({title:"\u767b\u5165\u5931\u6557",template:"\u683c\u5f0f\u6709\u8aa4\u3002"});a.then(function(a){accountL.value=
...
{text:"\u9001\u51fa",type:"button-chanry1",onTap:function(h){console.log("\u9078\u64c7\u9001\u51fa");firebase.auth().sendPasswordResetEmail(a.data.forgetInput+"@nkust.edu.tw").then(function(){console.log("\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u6210\u529f");k.alert({title:"\u6210\u529f",template:"\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u6210\u529f\uff0c\u8acb\u81f3 "+a.data.forgetInput+"@nkust.edu.tw \u6536\u4fe1"})})["catch"](function(a){console.log("\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u5931\u6557");
switch(a.code){case "auth/user-not-found":k.alert({title:"\u5bc4\u4fe1\u5931\u6557",template:"\u67e5\u7121\u6b64\u5e33\u865f\u3002"})}})}}]})}}]).controller("choose_classCtrl",["$scope","$stateParams","$state","$ionicLoading","$timeout",function(a,q,k,l,m){l.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u8f09\u5165\u8ab2\u7a0b\u4e2d...</p>'});var h=[],g=firebase.firestore();g.collection("\u8ab2\u7a0b").where("ClassStu","array-contains",q.StuID).get().then(function(g){g.forEach(function(c){h.push(c.data());
a.items=h;a.$apply()})});l.hide();a.choose_class=function(a,c){g.collection("\u7cfb\u7d71\u8a18\u9304").doc(a).collection("\u767b\u5165\u7d00\u9304").add({StuID:q.StuID,time:new Date}).then(function(a){console.log("\u7cfb\u7d71\u7d00\u9304 - \u767b\u5165\u7d00\u9304\u6210\u529f")})["catch"](function(a){console.error("\u7cfb\u7d71\u7d00\u9304 - \u767b\u5165\u7d00\u9304\u5931\u6557\uff1a",a)});localStorage.setItem("ClassID",a);localStorage.setItem("ClassName",c);k.go("menu.pbl")}}]).controller("chatroomCtrl",
["$scope","$stateParams","$state","$ionicLoading","$ionicScrollDelegate",function(a,q,k,l,m){var h=firebase.firestore();firebase.auth().onAuthStateChanged(function(g){if(g){console.log("\u5df2\u767b\u5165\u72c0\u614b");var f=g.email.substring(0,g.email.indexOf("@")).toUpperCase(),c=localStorage.getItem("ClassID"),e=localStorage.getItem("StuName");a.messages=[];h.collection("\u7559\u8a00\u7248").doc(c).collection("messages").orderBy("time","asc").onSnapshot(function(b){b.docChanges().forEach(function(b){"added"===
b.type&&h.collection("\u5e33\u865f").doc(b.doc.data().StuID).get().then(function(n){firebase.storage().ref().child("members/"+n.data().Img).getDownloadURL().then(function(d){a.messages.push({messageName:b.doc.data().StuID+" "+b.doc.data().StuName,messageImg:d,messageContent:b.doc.data().content,time:b.doc.data().time});a.$apply();m.scrollBottom();m.resize()})})["catch"](function(a){console.log("\u67e5\u8a62\u5716\u7247\u6a94\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)});"modified"===b.type&&console.log("\u4fee\u6539: ",
b.doc.data());"removed"===b.type&&console.log("\u522a\u9664: ",b.doc.data())})});a.addMessage=function(){l.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u65b0\u589e\u4e2d...</p>'});void 0!=a.inputMessage&&""!=a.inputMessage&&(h.collection("\u7559\u8a00\u7248").doc(c).collection("messages").add({StuID:f,StuName:e,content:a.inputMessage,time:new Date}).then(function(a){console.log("\u65b0\u589e\u7559\u8a00\u6210\u529f")})["catch"](function(a){console.error("\u65b0\u589e\u7559\u8a00\u5931\u6557\uff1a",
a)}),a.inputMessage="");l.hide()}}else console.log("\u5c1a\u672a\u767b\u5165"),k.go("login")})}]).controller("pblCtrl",["$scope","$stateParams","$state","$ionicPopup","$ionicLoading",function(a,q,k,l,m){var h=firebase.firestore();firebase.auth().onAuthStateChanged(function(g){if(g){console.log("\u5df2\u767b\u5165\u72c0\u614b");var f=g.email.substring(0,g.email.indexOf("@")).toUpperCase(),c=localStorage.getItem("ClassID");console.log(f);h.collection("\u8ab2\u7a0b").doc(c).onSnapshot(function(b){a.items=
[{ClassName:b.data().ClassName,ClassContent:b.data().ClassContent}];k.go(k.current,{},{reload:!0})},function(a){console.error("\u8b80\u53d6\u8ab2\u7a0b\u767c\u751f\u932f\u8aa4\uff1a",a);k.go("login")});h.collection("\u8ab2\u7a0b").doc(c).onSnapshot(function(b){a.LockGroupShow=b.data().inviteLock;k.go(k.current,{},{reload:!0});console.log("\u662f\u5426\u958b\u653e\u5206\u7d44\uff1a",a.LockGroupShow)},function(a){console.error("\u641c\u5c0b\u662f\u5426\u958b\u653e\u5206\u7d44\u767c\u751f\u932f\u8aa4\uff1a",
a)});var e="";h.collection("\u5206\u7d44").doc(c).collection("student").doc(f).onSnapshot(function(b){!1===b.data().grouped?(console.log("\u6c92\u6709\u5c0f\u7d44",b.data()),a.leaderGroupShow=!1,a.addGroupShow=!0,a.quitGroupShow=!1,a.members=[],localStorage.setItem("GroupID","none"),k.go(k.current,{},{reload:!0})):!0===b.data().grouped&&(console.log("\u6709\u5c0f\u7d44",b.data()),a.addGroupShow=!1,h.collection("\u5206\u7d44").doc(c).collection("group").where("leader","==",f).get().then(function(b){b.empty?
(console.log("\u4f60\u975e\u7d44\u9577"),a.quitGroupShow=!0):(console.log("\u4f60\u662f\u7d44\u9577"),b.forEach(function(a){e=a.id}),a.leaderGroupShow=!0,k.go(k.current,{},{reload:!0}))})["catch"](function(a){console.log("\u53d6\u5f97\u672a\u5206\u7d44\u540d\u55ae\u767c\u751f\u932f\u8aa4\uff1a",a)}))},function(a){console.log("\u641c\u5c0b\u662f\u5426\u5df2\u6709\u5c0f\u7d44\u767c\u751f\u932f\u8aa4\uff1a",a)});h.collection("\u5206\u7d44").doc(c).collection("group").where("members","array-contains",
f).onSnapshot(function(b){b.forEach(function(b){localStorage.setItem("GroupID",b.id);a.members=[];console.log("\u5c0f\u7d44\u72c0\u614b",b.data().members);for(var n={$jscomp$loop$prop$index$4:0};n.$jscomp$loop$prop$index$4<b.data().members.length;n={$jscomp$loop$prop$index$4:n.$jscomp$loop$prop$index$4},n.$jscomp$loop$prop$index$4++)h.collection("\u5e33\u865f").doc(b.data().members[n.$jscomp$loop$prop$index$4]).get().then(function(d){return function(n){var e=!1;0==d.$jscomp$loop$prop$index$4&&(e=
!0);firebase.storage().ref().child("members/"+n.data().Img).getDownloadURL().then(function(p){a.members.push({memberID:b.data().members[d.$jscomp$loop$prop$index$4],memberName:n.data().Name,memberImg:p,leader:e});k.go(k.current,{},{reload:!0});console.log(a.members)})}}(n))["catch"](function(a){console.log("\u67e5\u8a62\u5e33\u865f\u8cc7\u6599\u767c\u751f\u932f\u8aa4\uff1a",a)})})},function(a){console.log("\u6aa2\u67e5\u5c0f\u7d44\u72c0\u614b\u767c\u751f\u932f\u8aa4\uff1a",a)});a.addGroup=function(b){a.Stus=
[];m.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u8f09\u5165\u5b78\u751f\u4e2d...</p>'});h.collection("\u5206\u7d44").doc(c).collection("student").where("grouped","==",!1).get().then(function(b){b.empty?console.log("\u5168\u73ed\u90fd\u5df2\u5206\u7d44"):b.forEach(function(n){if(n.id!=f){var d=b.docs[b.docs.length-1].id;h.collection("\u5e33\u865f").doc(n.id).get().then(function(b){a.Stus.push({StuID:n.id,Name:b.data().Name,Checked:!1});k.go(k.current,{},{reload:!0});
n.id==d&&m.hide()})["catch"](function(a){console.log("\u67e5\u8a62\u59d3\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)})}});console.log("\u53d6\u5f97\u672a\u5206\u7d44\u540d\u55ae\uff1a",a.Stus);k.go(k.current,{},{reload:!0})})["catch"](function(a){console.log("\u53d6\u5f97\u672a\u5206\u7d44\u540d\u55ae\u767c\u751f\u932f\u8aa4\uff1a",a)});a.checkStus=[];h.collection("\u8ab2\u7a0b").doc(c).get().then(function(b){var n=0;n=0==a.members.length?1:a.members.length;a.maxMember={now:n+a.checkStus.length,maxMember:b.data().maxMembers};
a.check=function(d){-1===a.checkStus.indexOf(d)?a.checkStus.push(d):a.checkStus.splice(a.checkStus.indexOf(d),1);n+a.checkStus.length>b.data().maxMembers&&(console.log("\u8d85\u904e\u4e0a\u9650"),a.checkStus.splice(a.checkStus.indexOf(d),1),d=$.map(a.Stus,function(a,b){return a.StuID}).indexOf(d),a.Stus[d].Checked=!1);a.maxMember={now:n+a.checkStus.length,maxMember:b.data().maxMembers};console.log(a.checkStus)}})["catch"](function(a){console.log("\u67e5\u8a62\u7d44\u54e1\u4e0a\u9650\u767c\u751f\u932f\u8aa4\uff1a",
...
{text:"\u9080\u8acb",type:"button-chanry1",onTap:function(b){console.log("\u9078\u64c7\u9080\u8acb");0==a.checkStus.length?(console.log("\u8acb\u52fe\u9078\u6210\u54e1"),l.alert({title:"\u932f\u8aa4",template:"\u8acb\u9078\u64c7\u81f3\u5c11\u4e00\u540d\u6210\u54e1\u3002"})):h.collection("\u5206\u7d44").doc(c).collection("group").doc(e).update({inviting:a.checkStus}).then(function(){console.log("\u66f4\u65b0\u5c0f\u7d44\u9080\u8acb\u540d\u55ae\u6210\u529f");for(var b=0;b<a.checkStus.length;b++)h.collection("\u5206\u7d44").doc(c).collection("student").doc(a.checkStus[b]).collection("invite").add({leader:f,
...
scope:a,buttons:[{text:"\u53d6\u6d88",type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},{text:"\u5275\u7acb",type:"button-chanry1",onTap:function(b){console.log("\u9078\u64c7\u5275\u7acb");0==a.checkStus.length?(console.log("\u8acb\u52fe\u9078\u6210\u54e1"),l.alert({title:"\u932f\u8aa4",template:"\u8acb\u9078\u64c7\u81f3\u5c11\u4e00\u540d\u6210\u54e1\u3002"})):h.collection("\u5206\u7d44").doc(c).collection("group").add({leader:f,members:[f],inviting:a.checkStus}).then(function(b){var d=
b.id;console.log("\u65b0\u589e\u5c0f\u7d44\u6210\u529f");h.collection("\u5206\u7d44").doc(c).collection("student").doc(f).update({grouped:!0}).then(function(b){console.log("\u66f4\u65b0\u5165\u7d44\u72c0\u614b\u6210\u529f");for(b=0;b<a.checkStus.length;b++)h.collection("\u5206\u7d44").doc(c).collection("student").doc(a.checkStus[b]).collection("invite").add({leader:f,groupID:d,respond:!1}).then(function(a){console.log("\u50b3\u9001\u9080\u8acb\u901a\u77e5\u6210\u529f")})["catch"](function(a){console.error("\u50b3\u9001\u9080\u8acb\u901a\u77e5\u5931\u6557\uff1a",
...
buttons:[{text:"\u53d6\u6d88",type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},{text:"\u89e3\u6563",type:"button-chanry1",onTap:function(b){console.log("\u9078\u64c7\u89e3\u6563");h.collection("\u5206\u7d44").doc(c).collection("group").where("leader","==",f).get().then(function(b){b.empty?console.log("\u89e3\u6563\u5c0f\u7d44\u932f\u8aa4\uff1a\u975e\u7d44\u9577"):b.forEach(function(b){for(var d={$jscomp$loop$prop$index$6:0};d.$jscomp$loop$prop$index$6<b.data().inviting.length;d=
{$jscomp$loop$prop$index$6:d.$jscomp$loop$prop$index$6},d.$jscomp$loop$prop$index$6++)h.collection("\u5206\u7d44").doc(c).collection("student").doc(b.data().inviting[d.$jscomp$loop$prop$index$6]).collection("invite").where("groupID","==",b.id).get().then(function(a){return function(d){d.empty?console.log("\u6536\u56de\u9080\u8acb\u901a\u77e5\u932f\u8aa4\uff1a\u7121\u9808\u6536\u56de\u4e4b\u901a\u77e5"):d.forEach(function(d){h.collection("\u5206\u7d44").doc(c).collection("student").doc(b.data().inviting[a.$jscomp$loop$prop$index$6]).collection("invite").doc(d.id).update({respond:!0}).then(function(a){console.log("\u6536\u56de\u9080\u8acb\u901a\u77e5\u6210\u529f")})["catch"](function(a){console.error("\u6536\u56de\u9080\u8acb\u901a\u77e5\u5931\u6557\uff1a",
a)})})}}(d))["catch"](function(a){console.log("\u6536\u56de\u9080\u8acb\u901a\u77e5\u932f\u8aa4\uff1a",a)});for(d=0;d<b.data().members.length;d++)h.collection("\u5206\u7d44").doc(c).collection("student").doc(b.data().members[d]).update({grouped:!1}).then(function(a){console.log("\u66f4\u65b0\u5165\u7d44\u72c0\u614b\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0\u5165\u7d44\u72c0\u614b\u5931\u6557\uff1a",a)});h.collection("\u5206\u7d44").doc(c).collection("group").doc(b.id)["delete"]().then(function(b){console.log("\u89e3\u6563\u5c0f\u7d44\u6210\u529f");
...
h.collection("\u5206\u7d44").doc(c).collection("group").where("members","array-contains",f).get().then(function(a){a.forEach(function(a){var b=a.id;a=a.data().members;a.splice(a.indexOf(f),1);h.collection("\u5206\u7d44").doc(c).collection("group").doc(b).update({members:a}).then(function(a){console.log("\u66f4\u65b0members\u8cc7\u6599\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0members\u8cc7\u6599\u5931\u6557\uff1a",a)})})});h.collection("\u5206\u7d44").doc(c).collection("student").doc(f).update({grouped:!1}).then(function(a){console.log("\u66f4\u65b0\u5165\u7d44\u72c0\u614b\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0\u5165\u7d44\u72c0\u614b\u5931\u6557\uff1a",
a)})}}]})}}else console.log("\u5c1a\u672a\u767b\u5165"),k.go("login")})}]).controller("voteCtrl",["$scope","$stateParams","$ionicPopup",function(a,q,k){var l=firebase.firestore();firebase.auth().onAuthStateChanged(function(m){if(m){console.log("\u5df2\u767b\u5165\u72c0\u614b");var h=m.email.substring(0,m.email.indexOf("@")).toUpperCase(),g=localStorage.getItem("ClassID"),f=localStorage.getItem("GroupID"),c=localStorage.getItem("StuName");a.votes=[];l.collection("\u6295\u7968").doc(g).collection(f).onSnapshot(function(e){e.empty?
(console.log("\u76ee\u524d\u7121\u6295\u7968"),a.votes=[]):e.docChanges().forEach(function(b){if("added"===b.type){var e=!1,n=!1;-1!=b.doc.data().voteN.indexOf(h)?e=!0:-1!=b.doc.data().voteY.indexOf(h)&&(n=!0);var d=0==b.doc.data().solve?"\u6295\u7968\u4e2d":"\u5df2\u7d50\u6848";l.collection("\u5e33\u865f").doc(b.doc.data().StuID).get().then(function(c){firebase.storage().ref().child("members/"+c.data().Img).getDownloadURL().then(function(c){a.votes.push({voteID:b.doc.id,voteName:b.doc.data().StuID+
" "+b.doc.data().StuName,voteImg:c,title:b.doc.data().title,type:d,content:b.doc.data().content,voteN:b.doc.data().voteN,voteY:b.doc.data().voteY,voteChooseN:e,voteChooseY:n,time:b.doc.data().time});a.$apply();console.log("\u65b0\u589e\uff1a",a.votes)})})["catch"](function(a){console.log("\u67e5\u8a62\u5716\u7247\u6a94\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)})}if("modified"===b.type){n=e=!1;-1!=b.doc.data().voteN.indexOf(h)?e=!0:-1!=b.doc.data().voteY.indexOf(h)&&(n=!0);var c=a.votes.findIndex(function(a){return a.voteID===
...
console.log("\u522a\u9664\u5217\u8868\u4e0d\u6210\u529f"),a.$apply(),console.log("\u522a\u9664\uff1a",b.doc.data()))})},function(a){console.log("\u53d6\u5f97\u63d0\u8b70\u767c\u751f\u932f\u8aa4\uff1a",a)});a.votebtn=function(e,b){var c=a.votes.findIndex(function(a){return a.voteID===b});-1!=c?("N"==e?-1!=a.votes[c].voteN.indexOf(h)?(a.votes[c].voteN.splice(a.votes[c].voteN.indexOf(h),1),a.votes[c].voteChooseN=!1):(a.votes[c].voteN.push(h),a.votes[c].voteChooseN=!0,-1!=a.votes[c].voteY.indexOf(h)&&
(a.votes[c].voteY.splice(a.votes[c].voteY.indexOf(h),1),a.votes[c].voteChooseY=!1)):"Y"==e&&(-1!=a.votes[c].voteY.indexOf(h)?(a.votes[c].voteY.splice(a.votes[c].voteY.indexOf(h),1),a.votes[c].voteChooseY=!1):(a.votes[c].voteY.push(h),a.votes[c].voteChooseY=!0,-1!=a.votes[c].voteN.indexOf(h)&&(a.votes[c].voteN.splice(a.votes[c].voteN.indexOf(h),1),a.votes[c].voteChooseN=!1))),l.collection("\u5206\u7d44").doc(g).collection("group").doc(f).get().then(function(e){e=e.data().members.length;if(a.votes[c].voteN.length>
e/2||a.votes[c].voteY.length>e/2||a.votes[c].voteN.length==a.votes[c].voteY.length&&a.votes[c].voteY.length==e/2)console.log("\u95dc\u9589\u6295\u7968"),l.collection("\u6295\u7968").doc(g).collection(f).doc(b).update({solve:!0}).then(function(b){console.log("\u95dc\u9589\u6295\u7968\u6210\u529f");a.$apply()})["catch"](function(a){console.error("\u95dc\u9589\u6295\u7968\u5931\u6557\uff1a",a)})})["catch"](function(a){console.log("\u53d6\u5f97\u7d44\u54e1\u4eba\u6578\u767c\u751f\u932f\u8aa4\uff1a",a)}),
l.collection("\u6295\u7968").doc(g).collection(f).doc(b).update({voteN:a.votes[c].voteN,voteY:a.votes[c].voteY}).then(function(a){console.log("\u66f4\u65b0\u4f3a\u670d\u5668\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0\u4f3a\u670d\u5668\u5931\u6557\uff1a",a)})):console.log("\u53d6\u5f97\u8a72vote\u5931\u6557")};a.Addvote=function(){a.voteInput=[];k.show({title:"\u767c\u8d77\u6295\u7968",template:'<input type="text" ng-model="voteInput.title" placeholder="\u8f38\u5165\u6295\u7968\u6a19\u984c\uff08\u965015\u5b57\u5167\uff09..." maxlength="15" style="margin-bottom:10px; padding:8px;"><textarea cols="50" rows="5" ng-model="voteInput.content" placeholder="\u8f38\u5165\u6295\u7968\u8aaa\u660e\uff08\u965050\u5b57\u5167\uff09..." maxlength="50" style="margin-bottom:10px; padding:8px;"></textarea>',
...
k.alert({title:"\u932f\u8aa4",template:"\u8acb\u586b\u5beb\u6295\u7968\u8aaa\u660e\u3002"})):l.collection("\u6295\u7968").doc(g).collection(f).add({StuID:h,StuName:c,title:a.voteInput.title,content:a.voteInput.content,solve:!1,voteN:[],voteY:[h],time:new Date}).then(function(a){console.log("\u65b0\u589e\u6295\u7968\u6210\u529f")})["catch"](function(a){console.error("\u65b0\u589e\u6295\u7968\u5931\u6557\uff1a",a)})}}]})}}else console.log("\u5c1a\u672a\u767b\u5165"),$state.go("login")})}]).controller("missionCtrl",
["$scope","$stateParams","$sce","$state",function(a,q,k,l){var m=firebase.firestore();firebase.auth().onAuthStateChanged(function(h){if(h){console.log("\u5df2\u767b\u5165\u72c0\u614b");var g=h.email.substring(0,h.email.indexOf("@")).toUpperCase(),f=localStorage.getItem("ClassID");a.missions=[];m.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(f).collection("\u4efb\u52d9\u5217\u8868").onSnapshot(function(c){c.docChanges().forEach(function(c){if("added"===c.type){console.log("\u65b0\u589e: ",c.doc.data());
var b=0;1==c.doc.data().lock?b=3:-1!=c.doc.data().finished.indexOf(g)?b=1:c.doc.data().TimeOut.toDate()<new Date&&(b=2);var e=Number(c.doc.data().TimeOut.toDate().getMonth())+1,n=c.doc.data().TimeOut.toDate().getDate();9>=c.doc.data().TimeOut.toDate().getDate()&&(n="0"+c.doc.data().TimeOut.toDate().getDate());a.missions.push({missionID:c.doc.id,Name:c.doc.data().Name,Content:c.doc.data().Content,TimeOut:c.doc.data().TimeOut.toDate().getUTCFullYear()+"/"+e+"/"+n,LeaderOnly:c.doc.data().LeaderOnly,
type:c.doc.data().type,Point:c.doc.data().Point,finished:c.doc.data().finished,HTML:k.trustAsHtml(c.doc.data().HTML),time:c.doc.data().time,lock:b,show:!1,isIRS:c.doc.data().isIRS,showMsg:"\u67e5\u770b\u66f4\u591a"});a.$apply()}else"modified"===c.type?(console.log("\u4fee\u6539: ",c.doc.data()),e=a.missions.findIndex(function(a){return a.time.seconds===c.doc.data().time.seconds&a.time.nanoseconds===c.doc.data().time.nanoseconds}),-1!=e?(b=0,1==c.doc.data().lock?b=3:-1!=c.doc.data().finished.indexOf(g)?
...
function(c){m.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(f).collection("\u4efb\u52d9\u5217\u8868").doc(c).collection("\u586b\u7b54\u7d50\u679c").add({StuID:g,missionID:c,response:a.response,time:new Date}).then(function(a){console.log("\u56de\u50b3\u586b\u7b54\u7d50\u679c\u6210\u529f")})["catch"](function(a){console.error("\u56de\u50b3\u586b\u7b54\u7d50\u679c\u5931\u6557\uff1a",a)})}}else console.log("\u5c1a\u672a\u767b\u5165"),l.go("login")})}]).controller("irsCtrl",["$scope","$stateParams","$sce",
"$state","$ionicScrollDelegate",function(a,q,k,l,m){var h=firebase.firestore();firebase.auth().onAuthStateChanged(function(g){if(g&&null!=q.TestID){var f=function(d){clearInterval(p);if(d){for(d=1;d<=a.questions.length;d++)a.questions[d-1].answer==a.answer[d]&&(n+=1),d>=a.questions.length&&(a.test.Grade=n==a.questions.length?100:n*Math.round(100/a.questions.length));a.response=[{Grade:a.test.Grade,answer:a.answer}];h.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(e).collection("\u4efb\u52d9\u5217\u8868").doc(b).get().then(function(d){d=
d.data().finished;d.push(c);h.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(e).collection("\u4efb\u52d9\u5217\u8868").doc(b).update({finished:d}).then(function(){console.log("\u66f4\u65b0\u5df2\u5b8c\u6210\u540d\u55ae\u6210\u529f");a.$apply()})["catch"](function(a){console.error("\u66f4\u65b0\u5df2\u5b8c\u6210\u540d\u55ae\u5931\u6557",a)})})["catch"](function(a){console.log("\u53d6\u5f97\u5df2\u5b8c\u6210\u540d\u55ae\u767c\u751f\u932f\u8aa4\uff1a",a)})}else a.response=a.answer?[{answer:a.answer}]:[];
h.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(e).collection("\u4efb\u52d9\u5217\u8868").doc(b).collection("\u586b\u7b54\u7d50\u679c").doc(c).set({StuID:c,missionID:b,response:a.response,time:new Date}).then(function(a){console.log("\u56de\u50b3\u586b\u7b54\u7d50\u679c\u6210\u529f")})["catch"](function(a){console.error("\u56de\u50b3\u586b\u7b54\u7d50\u679c\u5931\u6557\uff1a",a)})};console.log("\u5df2\u767b\u5165\u72c0\u614b");var c=g.email.substring(0,g.email.indexOf("@")).toUpperCase(),e=localStorage.getItem("ClassID"),
b=q.TestID;h.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(e).collection("\u4efb\u52d9\u5217\u8868").doc(b).get().then(function(a){-1!=a.data().finished.indexOf(c)&&(console.log("\u5df2\u5b8c\u6210\u904e\u6e2c\u9a57"),l.go("login"))})["catch"](function(a){console.log("\u6aa2\u67e5\u662f\u5426\u5df2\u5b8c\u6210\u767c\u751f\u932f\u8aa4\uff1a",a)});a.test={};a.test.Name=q.TestName;a.test.Content=q.TestContent;var p,n=0;a.search="fkozq65K\u984c\u76ee\uff1a01";a.pageUpShow=!1;a.pageDownShow=!0;a.FinishBtnShow=
!1;a.testStart=!1;a.testContent=!0;a.testOver=!0;h.collection("IRS").doc(e).collection("\u6e2c\u9a57\u5217\u8868").doc(b).onSnapshot(function(b){function c(a){return 9>=a?"0"+String(a):a}var d=b.data().stageTime;a.distance=c(Math.floor(d/36E5))+":"+c(Math.floor(d%36E5/6E4))+":"+c(Math.floor(d%6E4/1E3));if(b.data().testStart){a.questions=b.data().questions;b=[];for(var e=0,n=a.questions.length;e<n;e++){var g=Math.floor(Math.random()*a.questions.length);b[e]=a.questions[g];a.questions.splice(g,1)}a.questions=
b;for(b=1;b<=a.questions.length;b++){var h;9>=b&&(h="0"+b);a.questions[b-1].search="fkozq65K\u984c\u76ee\uff1a"+h}a.testStart=!0;a.testContent=!1;a.pageUpDownShow=!0;a.$apply();p=setInterval(function(){d-=1E3;a.distance=c(Math.floor(d/36E5))+":"+c(Math.floor(d%36E5/6E4))+":"+c(Math.floor(d%6E4/1E3));a.$apply();0>=d&&1==a.testOver&&(f(!0),a.testStart=!0,a.testContent=!0,a.testOver=!1,a.pageUpDownShow=!1,m.scrollTop(),a.$apply())},1E3)}else f(!1),a.testStart=!1,a.testContent=!0,a.testOver=!0,a.pageUpDownShow=
...
console.log("\u522a\u9664\u5217\u8868\u4e0d\u6210\u529f"),a.$apply())})});a.add=function(){m.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u65b0\u589e\u4e2d...</p>'});void 0!=a.input&&""!=a.input&&(g.collection("\u8166\u529b\u6fc0\u76ea").doc(b).collection(p).add({StuID:c,StuName:e,msg:a.input,like:[],invited:!1,search:a.search,time:new Date}).then(function(a){console.log("\u65b0\u589e\u8166\u529b\u6fc0\u76ea\u6210\u529f")})["catch"](function(a){console.error("\u65b0\u589e\u8166\u529b\u6fc0\u76ea\u5931\u6557\uff1a",
a)}),a.input="");m.hide()};a.Delete=function(a){m.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u522a\u9664\u4e2d...</p>'});g.collection("\u8166\u529b\u6fc0\u76ea").doc(b).collection(p).where("time","==",a.time).get().then(function(a){a.forEach(function(a){g.collection("\u8166\u529b\u6fc0\u76ea").doc(b).collection(p).doc(a.id)["delete"]().then(function(){console.log("\u522a\u9664\u8166\u529b\u6fc0\u76ea\u6210\u529f")})["catch"](function(a){console.error("\u522a\u9664\u8166\u529b\u6fc0\u76ea\u5931\u6557\uff1a",
a)})})});m.hide()};a.like=function(a){1==a.likeBtn?(a.like.splice(a.like.indexOf(c),1),g.collection("\u8166\u529b\u6fc0\u76ea").doc(b).collection(p).doc(a.ID).update({like:a.like}).then(function(a){console.log("\u66f4\u65b0\u6309\u8b9a\u72c0\u614b\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0\u6309\u8b9a\u72c0\u614b\u5931\u6557\uff1a",a)})):(a.like.push(c),g.collection("\u8166\u529b\u6fc0\u76ea").doc(b).collection(p).doc(a.ID).update({like:a.like}).then(function(a){console.log("\u66f4\u65b0\u6309\u8b9a\u72c0\u614b\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0\u6309\u8b9a\u72c0\u614b\u5931\u6557\uff1a",
a)}))};g.collection("\u5206\u7d44").doc(b).collection("group").where("leader","==",c).get().then(function(b){b.empty?(console.log("\u4f60\u975e\u7d44\u9577"),a.DelAllBtnShow=!1):(console.log("\u4f60\u662f\u7d44\u9577"),a.DelAllBtnShow=!0)})["catch"](function(a){console.log("\u5224\u65b7\u7d44\u9577\u767c\u751f\u932f\u8aa4\uff1a",a)});a.DelAllBtn=function(){h.confirm({title:"\u6e05\u7a7a\u8166\u529b\u6fc0\u76ea\u8cc7\u6599",template:"\u78ba\u5b9a\u8981\u6e05\u7a7a\u55ce?",subTitle:"\u6ce8\u610f\uff1a\u6e05\u7a7a\u6703\u522a\u9664\u5168\u9ad4\u7d44\u54e1\u8166\u529b\u6fc0\u76ea\u8cc7\u6599\u3002",
buttons:[{text:"\u53d6\u6d88",type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},{text:"\u78ba\u5b9a",type:"button-chanry1",onTap:function(a){console.log("\u9078\u64c7\u6e05\u7a7a");g.collection("\u8166\u529b\u6fc0\u76ea").doc(b).collection(p).get().then(function(a){a.forEach(function(a){g.collection("\u8166\u529b\u6fc0\u76ea").doc(b).collection(p).doc(a.id)["delete"]().then(function(){console.log("\u522a\u9664\u8166\u529b\u6fc0\u76ea\u6210\u529f")})["catch"](function(a){console.error("\u522a\u9664\u8166\u529b\u6fc0\u76ea\u5931\u6557\uff1a",
a)})})})["catch"](function(a){console.log("\u67e5\u8a62\u5168\u90e8\u8a0a\u606f\u767c\u751f\u932f\u8aa4\uff1a",a)})}}]})}}else console.log("\u5c1a\u672a\u767b\u5165"),k.go("login")})}]).controller("proposalCtrl",["$scope","$stateParams","$state","$ionicPopup","$ionicLoading","$ionicScrollDelegate",function(a,q,k,l,m,h){var g=firebase.firestore();firebase.auth().onAuthStateChanged(function(f){if(f){console.log("\u5df2\u767b\u5165\u72c0\u614b");var c=f.email.substring(0,f.email.indexOf("@")).toUpperCase();
localStorage.getItem("StuName");var e=localStorage.getItem("ClassID"),b=localStorage.getItem("GroupID");g.collection("\u5206\u7d44").doc(e).collection("group").where("leader","==",c).get().then(function(b){b.empty?(console.log("\u4f60\u975e\u7d44\u9577"),a.leaderGroupShow=!1):(console.log("\u4f60\u662f\u7d44\u9577"),a.leaderGroupShow=!0)})["catch"](function(a){console.log("\u5224\u65b7\u7d44\u9577\u767c\u751f\u932f\u8aa4\uff1a",a)});a.items=[];g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).orderBy("time",
"asc").onSnapshot({includeMetadataChanges:!0},function(c){c.docChanges().forEach(function(c){if("added"===c.type){var d=c.doc.data(),n=[];d.brainstorming.forEach(function(c){g.collection("\u8166\u529b\u6fc0\u76ea").doc(e).collection(b).doc(c).get().then(function(b){n.push(b.data());a.$apply()})["catch"](function(a){console.log("\u8166\u529b\u6fc0\u76ea\u5167\u5bb9\u767c\u751f\u932f\u8aa4\uff1a",a)})});a.items.push({ProposalName:d.ProposalName,brainstorming:n,time:d.time});h.scrollBottom();console.log("\u65b0\u589e: ",
a.items)}else"modified"===c.type?(console.log("\u4fee\u6539: ",c.doc.data()),d=c.doc.data(),n=[],d.brainstorming.forEach(function(c){g.collection("\u8166\u529b\u6fc0\u76ea").doc(e).collection(b).doc(c).get().then(function(b){n.push(b.data());a.$apply()})["catch"](function(a){console.log("\u8166\u529b\u6fc0\u76ea\u5167\u5bb9\u767c\u751f\u932f\u8aa4\uff1a",a)})}),d=a.items.findIndex(function(a){return a.time.seconds===c.doc.data().time.seconds&a.time.nanoseconds===c.doc.data().time.nanoseconds}),a.items[d].brainstorming=
...
g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).where("time","==",d).get().then(function(d){d.forEach(function(d){n=d.id;p=g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).doc(n).collection("\u63d0\u8b70").where("solve","==",!1).onSnapshot(function(d){if(d.empty)console.log("\u76ee\u524d\u7121\u63d0\u8b70"),a.bells=[],m.hide();else{var n=d.docs.length,h=0;d.docChanges().forEach(function(d){if("added"===d.type){var f=[];d.doc.data().brainstorming.forEach(function(c){g.collection("\u8166\u529b\u6fc0\u76ea").doc(e).collection(b).doc(c).get().then(function(b){f.push({brainstormingID:b.id,
msg:b.data().msg});a.$apply()})["catch"](function(a){console.log("\u53d6\u5f97\u8166\u529b\u6fc0\u76ea\u5167\u5bb9\u767c\u751f\u932f\u8aa4\uff1a",a)})});var p=!1,k=!1;-1!=d.doc.data().voteN.indexOf(c)?p=!0:-1!=d.doc.data().voteY.indexOf(c)&&(k=!0);a.bells.push({bellID:d.doc.id,bellTime:d.doc.data().time,voteN:d.doc.data().voteN,voteY:d.doc.data().voteY,voteChooseN:p,voteChooseY:k,time:d.doc.data().time,bellBrainstorming:f});h++;h==n&&m.hide();a.$apply();console.log("\u65b0\u589e\uff1a",d.doc.data())}if("modified"===
...
scope:a,buttons:[{text:"\u95dc\u9589",type:"button-chanry1",onTap:function(a){console.log("\u9078\u64c7\u95dc\u9589");p()}}]})};a.votebtn=function(d,h){var f=a.bells.findIndex(function(a){return a.bellID===h});-1!=f?("N"==d?-1!=a.bells[f].voteN.indexOf(c)?(a.bells[f].voteN.splice(a.bells[f].voteN.indexOf(c),1),a.bells[f].voteChooseN=!1):(a.bells[f].voteN.push(c),a.bells[f].voteChooseN=!0,-1!=a.bells[f].voteY.indexOf(c)&&(a.bells[f].voteY.splice(a.bells[f].voteY.indexOf(c),1),a.bells[f].voteChooseY=
!1)):"Y"==d&&(-1!=a.bells[f].voteY.indexOf(c)?(a.bells[f].voteY.splice(a.bells[f].voteY.indexOf(c),1),a.bells[f].voteChooseY=!1):(a.bells[f].voteY.push(c),a.bells[f].voteChooseY=!0,-1!=a.bells[f].voteN.indexOf(c)&&(a.bells[f].voteN.splice(a.bells[f].voteN.indexOf(c),1),a.bells[f].voteChooseN=!1))),g.collection("\u5206\u7d44").doc(e).collection("group").doc(b).get().then(function(c){c=c.data().members.length;a.bells[f].voteN.length>c/2||a.bells[f].voteN.length==a.bells[f].voteY.length&&a.bells[f].voteY.length==
c/2?(console.log("\u5426\u6c7a\u63d0\u8b70or\u5e73\u624b"),g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).doc(n).collection("\u63d0\u8b70").doc(h).update({solve:!0}).then(function(b){console.log("\u95dc\u9589\u63d0\u8b70\u6210\u529f");a.$apply()})["catch"](function(a){console.error("\u95dc\u9589\u63d0\u8b70\u5931\u6557\uff1a",a)})):a.bells[f].voteY.length>c/2&&(console.log("\u63d0\u8b70\u6210\u7acb"),g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).doc(n).get().then(function(c){var d=
[];a.bells[f].bellBrainstorming.forEach(function(a){d.push(a.brainstormingID)});c=c.data().brainstorming.concat(d).concat();for(var p=0;p<c.length;++p)for(var k=p+1;k<c.length;++k)c[p]===c[k]&&c.splice(k,1);g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).doc(n).update({brainstorming:c}).then(function(c){console.log("\u66f4\u65b0\u63d0\u6848\u6210\u529f");d.forEach(function(c){g.collection("\u8166\u529b\u6fc0\u76ea").doc(e).collection(b).doc(c).update({invited:!0}).then(function(a){console.log("\u6a19\u8a18\u63d0\u6848\u6210\u529f")})["catch"](function(a){console.error("\u6a19\u8a18\u63d0\u6848\u5931\u6557\uff1a",
a)});g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).doc(n).collection("\u63d0\u8b70").doc(h).update({solve:!0}).then(function(b){console.log("\u95dc\u9589\u63d0\u8b70\u6210\u529f");a.$apply()})["catch"](function(a){console.error("\u95dc\u9589\u63d0\u8b70\u5931\u6557\uff1a",a)})})})["catch"](function(a){console.error("\u66f4\u65b0\u63d0\u6848\u5931\u6557\uff1a",a)})})["catch"](function(a){console.log("\u53d6\u5f97\u63d0\u6848\u805a\u7126\u5167\u8166\u529b\u6fc0\u76ea\u9663\u5217\u767c\u751f\u932f\u8aa4\uff1a",
a)}))})["catch"](function(a){console.log("\u53d6\u5f97\u7d44\u54e1\u4eba\u6578\u767c\u751f\u932f\u8aa4\uff1a",a)}),g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).doc(n).collection("\u63d0\u8b70").doc(h).update({voteN:a.bells[f].voteN,voteY:a.bells[f].voteY}).then(function(a){console.log("\u66f4\u65b0\u4f3a\u670d\u5668\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0\u4f3a\u670d\u5668\u5931\u6557\uff1a",a)})):console.log("\u53d6\u5f97\u8a72bell\u5931\u6557")};a.AddProposal=
function(d,f){a.proposals=[];m.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u8f09\u5165\u8166\u529b\u6fc0\u76ea\u4e2d...</p>'});g.collection("\u8166\u529b\u6fc0\u76ea").doc(e).collection(b).where("invited","==",!1).get().then(function(b){if(b.empty)console.log("\u5168\u90fd\u5df2\u65b0\u589eor\u7121\u8166\u529b\u6fc0\u76ea"),m.hide();else{var c=b.docs.length,d=0;b.forEach(function(b){a.proposals.push({ID:b.id,msg:b.data().msg,like:b.data().like.length,search:Number(b.data().search.substr(11))});
d++;d==c&&m.hide()});console.log("\u53d6\u5f97\u8166\u529b\u6fc0\u76ea\u540d\u55ae\uff1a",a.proposals)}})["catch"](function(a){console.log("\u53d6\u5f97\u672a\u5206\u7d44\u540d\u55ae\u767c\u751f\u932f\u8aa4\uff1a",a)});var n=[];a.proposalsForFilter=function(){n=[];return a.proposals};a.searchFilter=function(a){var b=-1==n.indexOf(a.search);b&&n.push(a.search);return b};a.checkProposals=[];a.proposalBtn=function(b){-1===a.checkProposals.indexOf(b)?a.checkProposals.push(b):a.checkProposals.splice(a.checkProposals.indexOf(b),
...
l.alert({title:"\u932f\u8aa4",template:"\u8acb\u52fe\u9078\u81f3\u5c11\u4e00\u9805\u8166\u529b\u6fc0\u76ea\u3002"})):g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).add({ProposalName:a.proposalInput.content,brainstorming:a.checkProposals,time:new Date}).then(function(c){console.log("\u65b0\u589e\u63d0\u6848\u6210\u529f");a.checkProposals.forEach(function(a){g.collection("\u8166\u529b\u6fc0\u76ea").doc(e).collection(b).doc(a).update({invited:!0}).then(function(a){console.log("\u6a19\u8a18\u63d0\u6848\u6210\u529f")})["catch"](function(a){console.error("\u6a19\u8a18\u63d0\u6848\u5931\u6557\uff1a",
...
scope:a,buttons:[{text:"\u53d6\u6d88",type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},{text:"\u52a0\u5165",type:"button-chanry1",onTap:function(c){console.log("\u9078\u64c7\u52a0\u5165");0==a.checkProposals.length?(console.log("\u8acb\u52fe\u9078\u8166\u529b\u6fc0\u76ea"),l.alert({title:"\u932f\u8aa4",template:"\u8acb\u52fe\u9078\u81f3\u5c11\u4e00\u9805\u8166\u529b\u6fc0\u76ea\u3002"})):g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).where("time","==",
f).get().then(function(c){c.forEach(function(c){var d=c.id;g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).doc(d).get().then(function(c){g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).doc(d).update({brainstorming:c.data().brainstorming.concat(a.checkProposals)}).then(function(c){console.log("\u66f4\u65b0\u63d0\u6848\u6210\u529f");a.checkProposals.forEach(function(a){g.collection("\u8166\u529b\u6fc0\u76ea").doc(e).collection(b).doc(a).update({invited:!0}).then(function(a){console.log("\u6a19\u8a18\u63d0\u6848\u6210\u529f")})["catch"](function(a){console.error("\u6a19\u8a18\u63d0\u6848\u5931\u6557\uff1a",
...
{text:"\u63d0\u8b70",type:"button-chanry1",onTap:function(d){console.log("\u9078\u64c7\u63d0\u8b70");0==a.checkProposals.length?(console.log("\u8acb\u52fe\u9078\u8166\u529b\u6fc0\u76ea"),l.alert({title:"\u932f\u8aa4",template:"\u8acb\u52fe\u9078\u81f3\u5c11\u4e00\u9805\u8166\u529b\u6fc0\u76ea\u3002"})):g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).where("time","==",f).get().then(function(d){d.forEach(function(d){d=d.id;g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).doc(d).collection("\u63d0\u8b70").add({StuID:c,
...
g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).where("time","==",a).get().then(function(a){a.forEach(function(a){var c=a.data().brainstorming;c.splice(c.indexOf(d),1);g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).doc(a.id).update({brainstorming:c}).then(function(a){console.log("\u66f4\u65b0\u8a72\u63d0\u6848\u4e4b\u8166\u529b\u6fc0\u76ea\u6e05\u55ae\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0\u8a72\u63d0\u6848\u4e4b\u8166\u529b\u6fc0\u76ea\u6e05\u55ae\u5931\u6557\uff1a",
a)});g.collection("\u8166\u529b\u6fc0\u76ea").doc(e).collection(b).doc(d).update({invited:!1}).then(function(a){console.log("\u6a19\u8a18\u63d0\u6848\u6210\u529f")})["catch"](function(a){console.error("\u6a19\u8a18\u63d0\u6848\u5931\u6557\uff1a",a)})})})["catch"](function(a){console.log("\u53d6\u5f97\u8a72\u63d0\u6848\u4e4b\u8166\u529b\u6fc0\u76ea\u6e05\u55ae\u767c\u751f\u932f\u8aa4\uff1a",a)})})})["catch"](function(a){console.log("\u53d6\u5f97\u8166\u529b\u6fc0\u76eaID\u767c\u751f\u932f\u8aa4\uff1a",
a)})};a.DelProposal=function(a){l.confirm({title:"\u522a\u9664\u63d0\u6848",template:"\u78ba\u5b9a\u8981\u522a\u9664\u6b64\u63d0\u6848\u55ce?",buttons:[{text:"\u53d6\u6d88",type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},{text:"\u78ba\u5b9a",type:"button-chanry1",onTap:function(c){console.log("\u9078\u64c7\u522a\u9664");g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).where("time","==",a).get().then(function(a){a.forEach(function(a){g.collection("\u63d0\u6848\u805a\u7126").doc(e).collection(b).doc(a.id)["delete"]().then(function(){console.log("\u522a\u9664\u63d0\u6848\u805a\u7126\u6210\u529f");
a.data().brainstorming.forEach(function(a){g.collection("\u8166\u529b\u6fc0\u76ea").doc(e).collection(b).doc(a).update({invited:!1}).then(function(a){console.log("\u6a19\u8a18\u63d0\u6848\u6210\u529f")})["catch"](function(a){console.error("\u6a19\u8a18\u63d0\u6848\u5931\u6557\uff1a",a)})})})["catch"](function(a){console.error("\u522a\u9664\u63d0\u6848\u805a\u7126\u5931\u6557\uff1a",a)})})})["catch"](function(a){console.log("\u67e5\u8a62\u5168\u90e8\u8a0a\u606f\u767c\u751f\u932f\u8aa4\uff1a",a)})}}]})}}else console.log("\u5c1a\u672a\u767b\u5165"),
k.go("login")})}]).controller("settingCtrl",["$scope","$stateParams","$ionicLoading","$ionicPopup",function(a,q,k,l){var m=firebase.firestore();firebase.auth().onAuthStateChanged(function(h){if(h){console.log("\u5df2\u767b\u5165\u72c0\u614b");var g=h.email.substring(0,h.email.indexOf("@")).toUpperCase(),f=localStorage.getItem("ClassID");a.Passward=function(){l.show({title:"\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1",template:"\u78ba\u5b9a\u8981\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u55ce?",buttons:[{text:"\u53d6\u6d88",
type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u53d6\u6d88")}},{text:"\u78ba\u5b9a",type:"button-chanry1",onTap:function(a){console.log("\u9078\u64c7\u78ba\u5b9a");k.show({template:"\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u4e2d..."});firebase.auth().sendPasswordResetEmail(g+"@nkust.edu.tw").then(function(){console.log("\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u6210\u529f");l.alert({title:"\u6210\u529f",template:"\u5bc4\u9001\u5bc6\u78bc\u91cd\u7f6e\u4fe1\u6210\u529f\uff0c\u8acb\u81f3 "+
...
c)console.log("\u672a\u9078\u64c7\u6a94\u6848"),k.hide(),l.alert({title:"\u672a\u9078\u64c7\u6a94\u6848",template:"\u8acb\u5148\u9078\u64c7\u6a94\u6848\u518d\u4e0a\u50b3"});else{var e=firebase.storage().ref(),b=new Date,f=g+b.getFullYear().toString()+b.getMonth()+b.getDate()+b.getHours()+b.getMinutes()+b.getSeconds()+b.getMilliseconds();e.child("members/"+f).putString(c,"data_url").on("state_changed",function(a){k.show({template:"\u5df2\u4e0a\u50b3 "+a.bytesTransferred/a.totalBytes*100+"%"});switch(a.state){case firebase.storage.TaskState.PAUSED:console.log("\u4e0a\u50b3\u66ab\u505c");
break;case firebase.storage.TaskState.RUNNING:console.log("\u4e0a\u50b3\u4e2d")}},function(b){console.log("\u4e0a\u50b3\u5931\u6557");k.hide();console.log(b);l.alert({title:"\u4e0a\u50b3\u5716\u7247\u5931\u6557",template:b});a.myImage="";a.myCroppedImage=""},function(){console.log("\u4e0a\u50b3\u6210\u529f");k.hide();a.myImage="";a.myCroppedImage="";e.child("members/"+f).getDownloadURL().then(function(a){document.getElementById("menu-img").src=a});m.collection("\u5e33\u865f").doc(g).update({Img:f}).then(function(a){console.log("\u66f4\u65b0DB\u6a94\u540d\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0DB\u6a94\u540d\u5931\u6557\uff1a",
a)});l.alert({title:"\u6210\u529f",template:"\u66f4\u63db\u7167\u7247\u5b8c\u6210\u3002"})})}};a.BugBtn=function(a){""==a||void 0==a?(console.log("\u8acb\u586b\u5beb\u5b8c\u6574"),l.alert({title:"\u932f\u8aa4",template:"\u8acb\u586b\u5beb\u5b8c\u6574\u3002"})):m.collection("\u7cfb\u7d71\u8a18\u9304").doc(f).collection("BUG\u56de\u5831").add({StuID:g,Content:a,time:new Date}).then(function(a){console.log("\u56de\u50b3\u4f3a\u670d\u5668\u6210\u529f");l.alert({title:"\u6210\u529f",template:"\u56de\u5831\u6210\u529f\uff0c\u611f\u8b1d\u60a8\u3002"})})["catch"](function(a){console.error("\u56de\u50b3\u4f3a\u670d\u5668\u5931\u6557\uff1a",
a);l.alert({title:"\u5931\u6557",template:"\u56de\u5831\u5931\u6557\uff0c\u8acb\u7a0d\u5019\u518d\u8a66\u3002"+a})})}}else console.log("\u5c1a\u672a\u767b\u5165"),$state.go("login")})}]).controller("menuCtrl",["$scope","$stateParams","$ionicPopup","$state",function(a,q,k,l){var m=firebase.firestore();firebase.auth().onAuthStateChanged(function(h){if(h){console.log("\u5df2\u767b\u5165\u72c0\u614b");var g=h.email.substring(0,h.email.indexOf("@")).toUpperCase(),f=localStorage.getItem("ClassID");m.collection("\u5e33\u865f").doc(g).get().then(function(a){document.getElementById("menu-heading1").innerText=
g+" "+a.data().Name;localStorage.setItem("StuName",a.data().Name)})["catch"](function(a){console.log("\u67e5\u8a62\u59d3\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)});document.getElementById("menu-list-item8").addEventListener("click",function(){firebase.auth().signOut().then(function(){console.log("\u767b\u51fa\u6210\u529f");localStorage.clear()})["catch"](function(a){console.log("\u767b\u51fa\u767c\u751f\u932f\u8aa4!")})},!1);m.collection("\u5e33\u865f").doc(g).get().then(function(a){console.log("\u66f4\u65b0\u5927\u982d\u7167\u6210\u529f");
firebase.storage().ref().child("members/"+a.data().Img).getDownloadURL().then(function(a){document.getElementById("menu-img").src=a})})["catch"](function(a){console.log("\u67e5\u8a62\u5716\u7247\u6a94\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)});document.getElementById("menu-heading2").innerText="Copyright \u00a9 2019 ver "+verson;m.collection("\u5206\u7d44").doc(f).collection("student").doc(g).collection("invite").where("respond","==",!1).onSnapshot(function(c){c.forEach(function(c){console.log("\u6709\u4eba\u9080\u8acb");
var b=c.data().groupID,e=c.id,h=c.data().leader;m.collection("\u5e33\u865f").doc(h).get().then(function(c){c=c.data().Name;k.show({title:"\u5c0f\u7d44\u9080\u8acb",subTitle:h+" "+c+" \u9080\u8acb\u4f60\u52a0\u5165\u5c0f\u7d44\u3002",template:'<img class="inviteImg" src="img/invite.jpg">',scope:a,buttons:[{text:"\u62d2\u7d55",type:"button-default",onTap:function(a){console.log("\u9078\u64c7\u62d2\u7d55");m.collection("\u5206\u7d44").doc(f).collection("student").doc(g).collection("invite").doc(e).update({respond:!0}).then(function(a){console.log("\u66f4\u65b0\u56de\u61c9\u72c0\u614b\u6210\u529f");
m.collection("\u5206\u7d44").doc(f).collection("group").doc(b).get().then(function(a){a=a.data().inviting;a.splice(a.indexOf(g),1);m.collection("\u5206\u7d44").doc(f).collection("group").doc(b).update({inviting:a}).then(function(a){console.log("\u66f4\u65b0inviting\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0inviting\u5931\u6557\uff1a",a)})})["catch"](function(a){console.log("\u6aa2\u67e5\u5c0f\u7d44\u662f\u5426\u9084\u5b58\u5728\uff0c\u53ef\u80fd\u5c0f\u7d44\u5df2\u89e3\u6563\uff1a",
a)})})["catch"](function(a){console.error("\u66f4\u65b0\u56de\u61c9\u72c0\u614b\u5931\u6557\uff1a",a)})}},{text:"\u63a5\u53d7",type:"button-chanry1",onTap:function(a){console.log("\u9078\u64c7\u63a5\u53d7");m.collection("\u5206\u7d44").doc(f).collection("student").doc(g).collection("invite").doc(e).update({respond:!0}).then(function(a){console.log("\u66f4\u65b0\u56de\u61c9\u72c0\u614b\u6210\u529f");m.collection("\u5206\u7d44").doc(f).collection("student").doc(g).update({grouped:!0}).then(function(a){console.log("\u66f4\u65b0\u5165\u7d44\u72c0\u614b\u6210\u529f");
m.collection("\u5206\u7d44").doc(f).collection("group").doc(b).get().then(function(a){var c=a.data().inviting;a=a.data().members;c.splice(c.indexOf(g),1);a.push(g);m.collection("\u5206\u7d44").doc(f).collection("group").doc(b).update({inviting:c,members:a}).then(function(a){console.log("\u66f4\u65b0inviting\u6210\u529f")})["catch"](function(a){console.error("\u66f4\u65b0inviting\u5931\u6557\uff1a",a)})})["catch"](function(a){console.log("\u6aa2\u67e5\u5c0f\u7d44\u662f\u5426\u9084\u5b58\u5728\uff0c\u53ef\u80fd\u5c0f\u7d44\u5df2\u89e3\u6563\uff1a",
...
a)})}}else console.log("\u975e\u7ba1\u7406\u54e1"),m.go("login")})}]).controller("root_groupCtrl",["$scope","$stateParams","$state","$ionicLoading",function(a,q,k,l){var m=firebase.firestore();firebase.auth().onAuthStateChanged(function(h){"rTO1FDz95FaN59B9FtOqyntQZ4J3"===h.uid?(console.log("\u5df2\u767b\u5165\u72c0\u614b"),a.cardShow=!1,m.collection("\u8ab2\u7a0b").get().then(function(g){a.AllClass=[];g.forEach(function(f){a.AllClass.push(f.data());k.go(k.current,{},{reload:!0})})}),a.choose_class=
function(g,f){a.cardShow=!1;l.show({template:'<ion-spinner icon="lines" class="spinner-calm"></ion-spinner><p>\u8f09\u5165\u8cc7\u6599\u4e2d...</p>'});a.Allgroups=[];var c=[];m.collection("\u5206\u7d44").doc(g).collection("student").where("grouped","==",!1).get().then(function(e){e.forEach(function(a){m.collection("\u5e33\u865f").doc(a.id).get().then(function(b){c.push(a.id+b.data().Name)})["catch"](function(a){console.log("\u67e5\u8a62\u59d3\u540d\u767c\u751f\u932f\u8aa4\uff1a",a)})});var b=[];m.collection("\u5206\u7d44").doc(g).collection("student").where("grouped",
...
fontWeight:"bold"}}},labelLine:{normal:{show:!1}},data:[{value:c.length,name:"\u672a\u5206\u7d44"},{value:b.length,name:"\u5df2\u5206\u7d44"}]}]},"object"===typeof option)&&e.setOption(option,!0);a.cardShow=!0;l.hide();k.go(k.current,{},{reload:!0})})});a.Allgroups2=[];m.collection("\u5206\u7d44").doc(g).collection("group").get().then(function(c){c.forEach(function(b){for(var c=b.data(),e={$jscomp$loop$prop$index$10:0};e.$jscomp$loop$prop$index$10<b.data().members.length;e={$jscomp$loop$prop$index$10:e.$jscomp$loop$prop$index$10},
...
"$sce",function(a,q,k,l,m){var h=firebase.firestore();firebase.auth().onAuthStateChanged(function(g){"rTO1FDz95FaN59B9FtOqyntQZ4J3"===g.uid?(console.log("\u5df2\u767b\u5165\u72c0\u614b"),a.cardShow=!1,h.collection("\u8ab2\u7a0b").get().then(function(f){a.AllClass=[];f.forEach(function(c){a.AllClass.push(c.data());k.go(k.current,{},{reload:!0})});console.log(a.AllClass)}),a.hide=function(){a.cardShow=!1},a.SelectBtn=function(f){if(void 0!=f){var c=f.ClassID;a.cardShow=!0;a.missions=[];h.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(c).collection("\u4efb\u52d9\u5217\u8868").onSnapshot(function(c){c.docChanges().forEach(function(b){if("added"===
...
optionD:"\u8cc7\u8a0a\u7ba1\u7406",answer:1}],h.collection("IRS").doc(b).collection("\u6e2c\u9a57\u5217\u8868").doc(c.id).set({Name:a.AddBtnPopup.Name,questions:a.AddBtnPopup.IRS.questions,stageTime:1E3*a.AddBtnPopup.IRS.stageTime,testStart:a.AddBtnPopup.IRS.testStart}).then(function(a){console.log("\u65b0\u589eIRS\u6210\u529f")})["catch"](function(a){console.error("\u65b0\u589eIRS\u5931\u6557\uff1a",a)}))})["catch"](function(a){console.error("\u65b0\u589e\u4efb\u52d9\u5931\u6557\uff1a",a)}))}}]})};
a.missionShow=function(c){var b=a.missions.findIndex(function(a){return a.$$hashKey===c.$$hashKey});-1!=b?(a.missions[b].show?(a.missions[b].show=!1,a.missions[b].showMsg="\u67e5\u770b\u66f4\u591a"):(a.missions[b].show=!0,a.missions[b].showMsg="\u6536\u5408\u5167\u5bb9"),console.log("\u4fee\u6539\u986f\u793a\u6210\u529f")):console.log("\u4fee\u6539\u986f\u793a\u4e0d\u6210\u529f")};a.response={};a.responseBtn=function(e){h.collection("\u8ab2\u7a0b\u4efb\u52d9").doc(c).collection("\u4efb\u52d9\u5217\u8868").doc(e).collection("\u586b\u7b54\u7d50\u679c").add({StuID:"\u6559\u5e2b\u7248",
